...
Shader "Vefects/SH_Vefects_VFX_HDRP_Shower_Water_Stream_01"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float lerpResult3_g11 = lerp( ( -1.0 * temp_output_4_0_g11 ) , temp_output_4_0_g11 , isFrontFace);
				...
				float op62 = saturate( ( saturate( ( saturate( ( max( tex2D( _ShowerTexture, panner70 ).g , tex2D( _ShowerTexture, panner71 ).g ) * saturate( texCoord56.y ) ) ) * distanceDepth36 ) ) * ( 1.0 - fresnelNode1_g11 ) ) );
				float4 fetchOpaqueVal23 = ASEHDSampleSceneColor(( (ase_screenPosNorm).xy + ( ( ( (appendResult97).xy + -0.5 ) * 2.0 ) * ( _NormalIntensity * ( op62 * packedInput.ase_color.a ) ) ) ), 0.0, GetInverseCurrentExposureMultiplier());
				float4 lerpResult24 = lerp( ( fetchOpaqueVal23 * 0.0001 ) , float4( _Color01 , 0.0 ) , _ColorStrength);
				
				float3 temp_cast_12 = (_Specular).xxx;
				...
				#ifdef _MATERIAL_FEATURE_SPECULAR_COLOR
				surfaceDescription.Specular = temp_cast_12;
				#endif
...
Node;AmplifyShaderEditor.SaturateNode;125;-768,-1408;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
WireConnection;62;0;125;0
WireConnection;30;0;79;0
WireConnection;30;1;29;4
WireConnection;24;0;123;0
...
WireConnection;112;0;24;0
WireConnection;112;1;101;0
WireConnection;112;5;104;0
WireConnection;112;6;102;0
WireConnection;112;7;105;0
WireConnection;112;9;63;0
ASEEND*/
//CHKSM=EB8F7C1B6B7C92BCB8FC9661C2B071F50471E14C
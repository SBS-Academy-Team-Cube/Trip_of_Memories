...
Shader "Vefects/SH_Vefects_VFX_HDRP_Fire_Sprinkler_01"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float2 texCoord195 = inputMesh.ase_texcoord * float2( 1,1 ) + float2( 0,0 );
				float2 panner197 = ( 1.0 * _Time.y * _WPOPanSpeed + ( texCoord195 * _WPOUVScale ));
				float2 texCoord205 = inputMesh.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float3 WPO200 = ( ( tex2Dlod( _WPOTexture, float4( panner197, 0, 0.0) ).g * ( inputMesh.normalOS * _WPOStrength ) ) * ( 1.0 - saturate( texCoord205.y ) ) );
						...
						)
			{
				...
				float2 texCoord84 = packedInput.ase_texcoord6.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float2 texCoord55 = packedInput.ase_texcoord6.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float2 texCoord56 = packedInput.ase_texcoord6.xy * float2( 1,1 ) + float2( 0,0 );
				float streamStrength125 = ( _StreamStrength * packedInput.ase_texcoord6.w );
				...
				float2 texCoord149 = packedInput.ase_texcoord6.xy * float2( 1,1 ) + float2( 0,0 );
				float4 ase_screenPosNorm = screenPos / screenPos.w;
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float screenDepth36 = LinearEyeDepth(SampleCameraDepth( ase_screenPosNorm.xy ),_ZBufferParams);
				...
				float lerpResult3_g14 = lerp( ( -1.0 * temp_output_4_0_g14 ) , temp_output_4_0_g14 , isFrontFace);
				...
				float4 fetchOpaqueVal23 = ASEHDSampleSceneColor(( ase_grabScreenPosNorm + float4( ( ( ( (temp_output_163_0).xy + -0.5 ) * 2.0 ) * ( ( _NormalIntensity * streamStrength125 ) * ( op62 * packedInput.ase_color.a ) ) ), 0.0 , 0.0 ) ).xy, 0.0, GetInverseCurrentExposureMultiplier());
				float4 lerpResult24 = lerp( ( fetchOpaqueVal23 * 0.0001 ) , float4( _Color01 , 0.0 ) , _ColorStrength);
				
				float2 texCoord175 = packedInput.ase_texcoord6.xy * float2( 1,1 ) + float2( 0,0 );
				float screenDepth178 = LinearEyeDepth(SampleCameraDepth( ase_screenPosNorm.xy ),_ZBufferParams);
				...
				float lerpResult3_g16 = lerp( ( -1.0 * temp_output_4_0_g16 ) , temp_output_4_0_g16 , isFrontFace);
				...
				float3 temp_cast_16 = (( _Specular * opNoMist190 )).xxx;
				
				surfaceDescription.BaseColor = lerpResult24.rgb;
				surfaceDescription.Normal = lerpResult193;
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = 0;

				#ifdef _MATERIAL_FEATURE_SPECULAR_COLOR
				surfaceDescription.Specular = temp_cast_16;
				#endif

				surfaceDescription.Emission = ( lerpResult24 * _EmissionIntensity ).rgb;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				float2 texCoord195 = inputMesh.uv0.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner197 = ( 1.0 * _Time.y * _WPOPanSpeed + ( texCoord195 * _WPOUVScale ));
				float2 texCoord205 = inputMesh.uv0.xy * float2( 1,1 ) + float2( 0,0 );
				float3 WPO200 = ( ( tex2Dlod( _WPOTexture, float4( panner197, 0, 0.0) ).g * ( inputMesh.normalOS * _WPOStrength ) ) * ( 1.0 - saturate( texCoord205.y ) ) );
				...
				float3 objectToViewPos = TransformWorldToView(TransformObjectToWorld(inputMesh.positionOS));
				float eyeDepth = -objectToViewPos.z;
				outputPackedVaryingsMeshToPS.ase_texcoord4.w = eyeDepth;
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float4 ase_grabScreenPos = ASE_ComputeGrabScreenPos( screenPos );
				float4 ase_grabScreenPosNorm = ase_grabScreenPos / ase_grabScreenPos.w;
				float2 texCoord84 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult4_g12 = (float2(_TilingX , _TilingY));
				float2 appendResult5_g12 = (float2(0.0 , 0.0));
				float2 panner91 = ( 1.0 * _Time.y * _PanSpeed + ( float3( ( ( texCoord84 * appendResult4_g12 ) + appendResult5_g12 ) ,  0.0 ) + float3( 0,0,0 ) ).xy);
				float4 tex2DNode94 = tex2D( _FireSprinklerTextureNormal, panner91 );
				float2 texCoord55 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult4_g11 = (float2(_TilingX , _TilingY));
				float2 appendResult5_g11 = (float2(0.0 , 0.0));
				float2 panner70 = ( 1.0 * _Time.y * _PanSpeed + ( float3( ( ( texCoord55 * appendResult4_g11 ) + appendResult5_g11 ) ,  0.0 ) + float3( 0,0,0 ) ).xy);
				float2 texCoord56 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float streamStrength125 = ( _StreamStrength * packedInput.ase_texcoord3.w );
				float temp_output_59_0 = saturate( ( saturate( ( ( tex2D( _FireSprinklerTexture, panner70 ).r - ( 1.0 - saturate( texCoord56.y ) ) ) - ( 1.0 - streamStrength125 ) ) ) * _ThickPartsOpacity ) );
				float3 appendResult156 = (float3(( tex2DNode94.r * temp_output_59_0 ) , ( tex2DNode94.g * temp_output_59_0 ) , tex2DNode94.b));
				float2 appendResult4_g13 = (float2(_TilingXDroplets , _TilingYDroplets));
				float2 appendResult5_g13 = (float2(0.0 , 0.0));
				...
				float3 temp_output_163_0 = ( ( appendResult156 * 0.5 ) + ( appendResult160 * 0.5 ) );
				float temp_output_147_0 = saturate( max( temp_output_59_0 , temp_output_146_0 ) );
				float2 texCoord149 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float4 ase_screenPosNorm = screenPos / screenPos.w;
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float screenDepth36 = LinearEyeDepth(SampleCameraDepth( ase_screenPosNorm.xy ),_ZBufferParams);
				float distanceDepth36 = saturate( ( screenDepth36 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _DepthFade ) );
				...
				float2 texCoord175 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float screenDepth178 = LinearEyeDepth(SampleCameraDepth( ase_screenPosNorm.xy ),_ZBufferParams);
				float distanceDepth178 = saturate( ( screenDepth178 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _DepthFade ) );
				float3 tanNormal1_g16 = float4( norm100 , 0.0 ).rgb;
				float temp_output_4_0_g16 = _FresnelPower;
		...
		Pass
		{
			...
			UNITY_SETUP_INSTANCE_ID(packedInput);
				...
				float2 texCoord55 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult4_g11 = (float2(_TilingX , _TilingY));
				float2 appendResult5_g11 = (float2(0.0 , 0.0));
				float2 panner70 = ( 1.0 * _Time.y * _PanSpeed + ( float3( ( ( texCoord55 * appendResult4_g11 ) + appendResult5_g11 ) ,  0.0 ) + float3( 0,0,0 ) ).xy);
				float2 texCoord56 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float streamStrength125 = ( _StreamStrength * packedInput.ase_texcoord1.w );
				float temp_output_59_0 = saturate( ( saturate( ( ( tex2D( _FireSprinklerTexture, panner70 ).r - ( 1.0 - saturate( texCoord56.y ) ) ) - ( 1.0 - streamStrength125 ) ) ) * _ThickPartsOpacity ) );
				float2 appendResult4_g10 = (float2(_TilingXDroplets , _TilingYDroplets));
				float2 appendResult5_g10 = (float2(0.0 , 0.0));
				float2 panner71 = ( 1.0 * _Time.y * _PanSpeedDroplets + ( float3( ( ( texCoord55 * appendResult4_g10 ) + appendResult5_g10 ) ,  0.0 ) + float3( 0,0,0 ) ).xy);
				float temp_output_146_0 = saturate( ( saturate( ( saturate( tex2D( _FireSprinklerTexture, panner71 ).g ) * streamStrength125 ) ) * _DropsOpacity ) );
				float temp_output_147_0 = saturate( max( temp_output_59_0 , temp_output_146_0 ) );
				float2 texCoord149 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float4 screenPos = packedInput.ase_texcoord2;
				float4 ase_screenPosNorm = screenPos / screenPos.w;
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float screenDepth36 = LinearEyeDepth(SampleCameraDepth( ase_screenPosNorm.xy ),_ZBufferParams);
				...
				float3 ase_viewVectorWS = ( _WorldSpaceCameraPos.xyz - ase_worldPos );
				float3 ase_viewDirWS = normalize( ase_viewVectorWS );
				float2 texCoord84 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult4_g12 = (float2(_TilingX , _TilingY));
				float2 appendResult5_g12 = (float2(0.0 , 0.0));
				float2 panner91 = ( 1.0 * _Time.y * _PanSpeed + ( float3( ( ( texCoord84 * appendResult4_g12 ) + appendResult5_g12 ) ,  0.0 ) + float3( 0,0,0 ) ).xy);
				float4 tex2DNode94 = tex2D( _FireSprinklerTextureNormal, panner91 );
		...
		Pass
		{
			...
			AttributesMesh ApplyMeshModification(AttributesMesh inputMesh, float3 timeParameters, inout PackedVaryingsMeshToPS outputPackedVaryingsMeshToPS )
			{
				...
				float3 objectToViewPos = TransformWorldToView(TransformObjectToWorld(inputMesh.positionOS));
				float eyeDepth = -objectToViewPos.z;
				outputPackedVaryingsMeshToPS.ase_texcoord9.w = eyeDepth;
						...
						)
			{
				...
				float4 ase_grabScreenPos = ASE_ComputeGrabScreenPos( screenPos );
				float4 ase_grabScreenPosNorm = ase_grabScreenPos / ase_grabScreenPos.w;
				float2 texCoord84 = packedInput.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult4_g12 = (float2(_TilingX , _TilingY));
				float2 appendResult5_g12 = (float2(0.0 , 0.0));
				float2 panner91 = ( 1.0 * _Time.y * _PanSpeed + ( float3( ( ( texCoord84 * appendResult4_g12 ) + appendResult5_g12 ) ,  0.0 ) + float3( 0,0,0 ) ).xy);
				float4 tex2DNode94 = tex2D( _FireSprinklerTextureNormal, panner91 );
				float2 texCoord55 = packedInput.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult4_g11 = (float2(_TilingX , _TilingY));
				float2 appendResult5_g11 = (float2(0.0 , 0.0));
				float2 panner70 = ( 1.0 * _Time.y * _PanSpeed + ( float3( ( ( texCoord55 * appendResult4_g11 ) + appendResult5_g11 ) ,  0.0 ) + float3( 0,0,0 ) ).xy);
				float2 texCoord56 = packedInput.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				float streamStrength125 = ( _StreamStrength * packedInput.ase_texcoord8.w );
				float temp_output_59_0 = saturate( ( saturate( ( ( tex2D( _FireSprinklerTexture, panner70 ).r - ( 1.0 - saturate( texCoord56.y ) ) ) - ( 1.0 - streamStrength125 ) ) ) * _ThickPartsOpacity ) );
				float3 appendResult156 = (float3(( tex2DNode94.r * temp_output_59_0 ) , ( tex2DNode94.g * temp_output_59_0 ) , tex2DNode94.b));
				float2 appendResult4_g13 = (float2(_TilingXDroplets , _TilingYDroplets));
				float2 appendResult5_g13 = (float2(0.0 , 0.0));
				...
				float3 temp_output_163_0 = ( ( appendResult156 * 0.5 ) + ( appendResult160 * 0.5 ) );
				float temp_output_147_0 = saturate( max( temp_output_59_0 , temp_output_146_0 ) );
				float2 texCoord149 = packedInput.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				float4 ase_screenPosNorm = screenPos / screenPos.w;
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float screenDepth36 = LinearEyeDepth(SampleCameraDepth( ase_screenPosNorm.xy ),_ZBufferParams);
				float distanceDepth36 = saturate( ( screenDepth36 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _DepthFade ) );
				...
				float fresnelNdotV1_g14 = dot( float3(dot(tanToWorld0,tanNormal1_g14), dot(tanToWorld1,tanNormal1_g14), dot(tanToWorld2,tanNormal1_g14)), ase_viewDirWS );
				float fresnelNode1_g14 = ( _FresnelBias + _FresnelScale * pow( 1.0 - fresnelNdotV1_g14, lerpResult3_g14 ) );
				float eyeDepth = packedInput.ase_texcoord9.w;
				float cameraDepthFade111 = (( eyeDepth -_ProjectionParams.y - _CameraDepthFadeOffset ) / _CameraDepthFadeLength);
				float op62 = saturate( ( saturate( ( saturate( ( saturate( ( saturate( ( temp_output_147_0 + saturate( ( _MistOpacity * streamStrength125 ) ) ) ) * saturate( texCoord149.y ) ) ) * distanceDepth36 ) ) * ( 1.0 - fresnelNode1_g14 ) ) ) * saturate( cameraDepthFade111 ) ) );
				float4 fetchOpaqueVal23 = ASEHDSampleSceneColor(( ase_grabScreenPosNorm + float4( ( ( ( (temp_output_163_0).xy + -0.5 ) * 2.0 ) * ( ( _NormalIntensity * streamStrength125 ) * ( op62 * packedInput.ase_color.a ) ) ), 0.0 , 0.0 ) ).xy, 0.0, GetInverseCurrentExposureMultiplier());
				float4 lerpResult24 = lerp( ( fetchOpaqueVal23 * 0.0001 ) , float4( _Color01 , 0.0 ) , _ColorStrength);
				
				float2 texCoord175 = packedInput.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				float screenDepth178 = LinearEyeDepth(SampleCameraDepth( ase_screenPosNorm.xy ),_ZBufferParams);
				float distanceDepth178 = saturate( ( screenDepth178 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _DepthFade ) );
				float3 tanNormal1_g16 = float4( norm100 , 0.0 ).rgb;
				float temp_output_4_0_g16 = _FresnelPower;
		...
		Pass
        {
			...
			UNITY_SETUP_INSTANCE_ID(packedInput);
				...
				float2 texCoord55 = packedInput.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult4_g11 = (float2(_TilingX , _TilingY));
				float2 appendResult5_g11 = (float2(0.0 , 0.0));
				float2 panner70 = ( 1.0 * _Time.y * _PanSpeed + ( float3( ( ( texCoord55 * appendResult4_g11 ) + appendResult5_g11 ) ,  0.0 ) + float3( 0,0,0 ) ).xy);
				float2 texCoord56 = packedInput.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float streamStrength125 = ( _StreamStrength * packedInput.ase_texcoord7.w );
				float temp_output_59_0 = saturate( ( saturate( ( ( tex2D( _FireSprinklerTexture, panner70 ).r - ( 1.0 - saturate( texCoord56.y ) ) ) - ( 1.0 - streamStrength125 ) ) ) * _ThickPartsOpacity ) );
				float2 appendResult4_g10 = (float2(_TilingXDroplets , _TilingYDroplets));
				float2 appendResult5_g10 = (float2(0.0 , 0.0));
				float2 panner71 = ( 1.0 * _Time.y * _PanSpeedDroplets + ( float3( ( ( texCoord55 * appendResult4_g10 ) + appendResult5_g10 ) ,  0.0 ) + float3( 0,0,0 ) ).xy);
				float temp_output_146_0 = saturate( ( saturate( ( saturate( tex2D( _FireSprinklerTexture, panner71 ).g ) * streamStrength125 ) ) * _DropsOpacity ) );
				float temp_output_147_0 = saturate( max( temp_output_59_0 , temp_output_146_0 ) );
				float2 texCoord149 = packedInput.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float3 ase_viewVectorWS = ( _WorldSpaceCameraPos.xyz - ase_worldPos );
				float3 ase_viewDirWS = normalize( ase_viewVectorWS );
				float2 texCoord84 = packedInput.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult4_g12 = (float2(_TilingX , _TilingY));
				float2 appendResult5_g12 = (float2(0.0 , 0.0));
				float2 panner91 = ( 1.0 * _Time.y * _PanSpeed + ( float3( ( ( texCoord84 * appendResult4_g12 ) + appendResult5_g12 ) ,  0.0 ) + float3( 0,0,0 ) ).xy);
				float4 tex2DNode94 = tex2D( _FireSprinklerTextureNormal, panner91 );
...
Node;AmplifyShaderEditor.RangedFloatNode;66;-8320,-896;Inherit;False;Property;_TilingY;Tiling Y;14;0;Create;True;0;0;0;False;0;False;4;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;65;-8320,-1024;Inherit;False;Property;_TilingX;Tiling X;13;0;Create;True;0;0;0;False;0;False;4;3;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;122;-8320,-640;Inherit;False;Property;_TilingXDroplets;Tiling X Droplets;16;0;Create;True;0;0;0;False;0;False;4;20;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;121;-8320,-512;Inherit;False;Property;_TilingYDroplets;Tiling Y Droplets;17;0;Create;True;0;0;0;False;0;False;4;0.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;72;-7296,-1152;Inherit;False;Property;_PanSpeed;Pan Speed;15;0;Create;True;0;0;0;False;0;False;-0.03,1;0.0777,2.69;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;123;-7296,-512;Inherit;False;Property;_PanSpeedDroplets;Pan Speed Droplets;18;0;Create;True;0;0;0;False;0;False;-0.73,1.17;-0.013,1.777;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;138;-4096,-1152;Inherit;False;Property;_MistOpacity;Mist Opacity;6;0;Create;True;0;0;0;False;3;Space(33);Header(Opacity);Space(13);False;0.2;0.1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;108;-1024,-768;Inherit;False;Property;_FresnelPower;Fresnel Power;21;0;Create;True;0;0;0;False;0;False;5;3;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;211;-4352,2816;Inherit;False;Property;_WPOPanSpeed;WPO Pan Speed;28;0;Create;True;0;0;0;False;0;False;0.2,1;0.1,2;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;28;-768,-128;Inherit;False;Property;_ColorStrength;Color Strength;2;0;Create;True;0;0;0;False;0;False;0.1;0.3;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;20;-1536,0;Inherit;False;2;2;0;FLOAT4;0,0,0,0;False;1;FLOAT2;0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.RangedFloatNode;103;-768,0;Inherit;False;Property;_EmissionIntensity;Emission Intensity;3;0;Create;True;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;33;-2304,640;Inherit;False;Property;_NormalIntensity;Normal Intensity;11;0;Create;True;0;0;0;False;0;False;0.25;0.01;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;26;-1152,-384;Inherit;False;Property;_Color01;Color 01;1;0;Create;True;0;0;0;False;3;Space(33);Header(Attributes);Space(13);False;1,1,1,0;1,1,1,1;True;False;0;6;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.GrabScreenPosition;233;-2048,-208;Inherit;False;0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;234;0;23;0
WireConnection;234;1;235;0
WireConnection;221;0;24;0
WireConnection;221;1;193;0
WireConnection;221;5;172;0
WireConnection;221;6;102;0
WireConnection;221;7;105;0
WireConnection;221;9;63;0
WireConnection;221;11;201;0
ASEEND*/
//CHKSM=CE484B5B8B018D27154AD8391FD1D826B38505DF
...
Shader "Vefects/SH_Vefects_VFX_HDRP_Sprinkler_Tail_01"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float streamLengthPercentage125 = ( _StreamLengthPercentage * inputMesh.ase_texcoord.w );
				...
				float random312 = inputMesh.ase_texcoord.z;
						...
						)
			{
				...
				float random312 = packedInput.ase_texcoord6.z;
				...
				float2 texCoord289 = packedInput.ase_texcoord6.xy * float2( 1,1 ) + float2( 0,0 );
				float2 texCoord284 = packedInput.ase_texcoord6.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float lerpResult3_g26 = lerp( ( -1.0 * temp_output_4_0_g26 ) , temp_output_4_0_g26 , isFrontFace);
				...
				float4 temp_output_319_0 = ( fetchOpaqueVal23 * 0.0001 );
				float4 lerpResult24 = lerp( temp_output_319_0 , ( float4( _Color01 , 0.0 ) + temp_output_319_0 ) , _ColorStrength);
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				float streamLengthPercentage125 = ( _StreamLengthPercentage * inputMesh.uv0.w );
				float lerpResult222 = lerp( 0.1 , 1.0 , streamLengthPercentage125);
				float2 appendResult218 = (float2(texCoord195.x , ( texCoord195.y * lerpResult222 )));
				float2 panner197 = ( 1.0 * _Time.y * _WPOPanSpeed + ( appendResult218 * _WPOUVScale ));
				float random312 = inputMesh.uv0.z;
				float4 tex2DNode199 = tex2Dlod( _WPOTexture, float4( ( panner197 + random312 ), 0, 0.0) );
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float random312 = packedInput.ase_texcoord3.z;
				float2 panner300 = ( 1.0 * _Time.y * _SprinklerUVPan + ( ( texCoord297 + random312 ) * _SprinklerUVScale ));
				float3 lerpResult235 = lerp( float3(0,0,1) , tex2D( _SprinklerTextureNormal, panner300 ).rgb , _NormalIntensity);
				float3 norm100 = lerpResult235;
				float streamLengthPercentage125 = ( _StreamLengthPercentage * packedInput.ase_texcoord3.w );
				float2 texCoord289 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 texCoord284 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
		...
		Pass
		{
			...
			UNITY_SETUP_INSTANCE_ID(packedInput);
				...
				float random312 = packedInput.ase_texcoord1.z;
				float2 panner300 = ( 1.0 * _Time.y * _SprinklerUVPan + ( ( texCoord297 + random312 ) * _SprinklerUVScale ));
				float2 texCoord289 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float2 texCoord284 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
		...
		Pass
		{
						...
						)
			{
				...
				float random312 = packedInput.ase_texcoord8.z;
				float2 panner300 = ( 1.0 * _Time.y * _SprinklerUVPan + ( ( texCoord297 + random312 ) * _SprinklerUVScale ));
				float3 lerpResult235 = lerp( float3(0,0,1) , tex2D( _SprinklerTextureNormal, panner300 ).rgb , _NormalIntensity);
				float3 norm100 = lerpResult235;
				float streamLengthPercentage125 = ( _StreamLengthPercentage * packedInput.ase_texcoord8.w );
				float2 texCoord289 = packedInput.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				float2 texCoord284 = packedInput.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
		...
		Pass
        {
			...
			UNITY_SETUP_INSTANCE_ID(packedInput);
				...
				float random312 = packedInput.ase_texcoord7.z;
				float2 panner300 = ( 1.0 * _Time.y * _SprinklerUVPan + ( ( texCoord297 + random312 ) * _SprinklerUVScale ));
				float2 texCoord289 = packedInput.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float2 texCoord284 = packedInput.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
...
Node;AmplifyShaderEditor.RangedFloatNode;293;-4736,-2304;Inherit;False;Property;_PowerEdges;Power Edges;8;0;Create;True;0;0;0;False;0;False;2;2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;301;-7168,-1664;Inherit;False;Property;_SprinklerUVPan;Sprinkler UV Pan;14;0;Create;True;0;0;0;False;0;False;0.777,3.333;4,4;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.Vector2Node;240;-4608,2816;Inherit;False;Property;_WPOUVScale;WPO UV Scale;23;0;Create;True;0;0;0;False;0;False;1,1;0.3,0.5;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.Vector2Node;211;-4352,2816;Inherit;False;Property;_WPOPanSpeed;WPO Pan Speed;24;0;Create;True;0;0;0;False;0;False;0.1,-3;0.113,-1.333;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;38;-1664,-1152;Inherit;False;Property;_DepthFade;Depth Fade;18;0;Create;True;0;0;0;False;3;Space(33);Header(Depth Fade);Space(13);False;1;0.05;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;33;-2304,640;Inherit;False;Property;_NormalDistortionIntensity;Normal Distortion Intensity;10;0;Create;True;0;0;0;False;0;False;0.25;0.03;0;0;0;1;FLOAT;0
...
WireConnection;319;0;23;0
WireConnection;319;1;320;0
WireConnection;321;0;24;0
WireConnection;321;1;101;0
WireConnection;321;5;104;0
WireConnection;321;6;102;0
WireConnection;321;7;105;0
WireConnection;321;9;63;0
WireConnection;321;11;201;0
ASEEND*/
//CHKSM=22EDF319F44D3AC5DB49172571168BB923C93C7D
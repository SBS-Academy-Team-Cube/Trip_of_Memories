...
Shader "Vefects/SH_Vefects_VFX_HDRP_Water_On_Surfaces_01"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float3 objToWorld86_g63 = GetAbsolutePositionWS(mul( GetObjectToWorldMatrix(), float4( float3( 0,0,0 ), 1 ) ).xyz);
				#ifdef _USEWORLDSPACE_ON
				float3 staticSwitch95_g63 = ase_worldPos;
				#else
				float3 staticSwitch95_g63 = ( ase_worldPos - objToWorld86_g63 );
				#endif
				...
				float3 temp_output_65_0_g63 = pow( abs( normalWS ) , temp_cast_0 );
				...
				float3 temp_output_101_0_g63 = pow( abs( normalWS ) , temp_cast_1 );
				...
				float lerpResult147_g63 = lerp( packedInput.ase_normal.y , normalizedWorldNormal.y , _BottomMaskWorldNormal);
				...
				float lerpResult49_g63 = lerp( 1.0 , packedInput.ase_color.r , _UseVertexColorAsMask);
				...
				surfaceDescription.Normal = lerpResult15_g63;
				...
				surfaceDescription.Smoothness = lerpResult54_g63;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float3 temp_cast_0 = (_ProjectTransitionContrast).xxx;
				float3 temp_output_65_0_g63 = pow( abs( ase_worldNormal ) , temp_cast_0 );
				float3 break83_g63 = temp_output_65_0_g63;
				float3 break67_g63 = ( temp_output_65_0_g63 / ( break83_g63.x + break83_g63.y + break83_g63.z ) );
				float2 temp_output_77_0_g63 = (temp_output_90_0_g63).yz;
				float2 temp_output_78_0_g63 = (temp_output_90_0_g63).xz;
				float3 normalizeResult63_g63 = normalize( ( ( UnpackNormalScale( tex2D( _WaterDropsNormal, temp_output_76_0_g63 ), 1.0f ) * break67_g63.z ) + ( UnpackNormalScale( tex2D( _WaterDropsNormal, temp_output_77_0_g63 ), 1.0f ) * break67_g63.x ) + ( UnpackNormalScale( tex2D( _WaterDropsNormal, temp_output_78_0_g63 ), 1.0f ) * break67_g63.y ) ) );
				float3 temp_cast_1 = (_ProjectTransitionContrast).xxx;
				float3 temp_output_101_0_g63 = pow( abs( ase_worldNormal ) , temp_cast_1 );
				float3 break115_g63 = temp_output_101_0_g63;
				float3 break103_g63 = ( temp_output_101_0_g63 / ( break115_g63.x + break115_g63.y + break115_g63.z ) );
				float4 temp_output_105_0_g63 = ( tex2D( _WaterDropsMask, temp_output_76_0_g63 ) * break103_g63.z );
				float temp_output_34_0_g63 = (( temp_output_105_0_g63 + ( tex2D( _WaterDropsMask, temp_output_77_0_g63 ) * break103_g63.x ) + ( tex2D( _WaterDropsMask, temp_output_78_0_g63 ) * break103_g63.y ) )).r;
...
WireConnection;316;0;298;0
WireConnection;316;1;308;0
WireConnection;316;5;308;140
WireConnection;316;7;308;13
ASEEND*/
//CHKSM=BBC8B79F85C8F320BC3D64513B5A16F6C03F2EBE
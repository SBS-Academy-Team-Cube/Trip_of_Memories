...
Shader "Vefects/SH_Vefects_VFX_HDRP_Water_Mist_01"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
					...
					)
			{
				...
				float4 lerpResult42 = lerp( packedInput.ase_color , temp_cast_0 , _AOStrength);
				float4 lerpResult43 = lerp( packedInput.ase_color , lerpResult42 , tex2DNode16.a);
				
				float smoothstepResult45 = smoothstep( packedInput.ase_texcoord1.z , ( packedInput.ase_texcoord1.z + 1.0 ) , tex2DNode16.a);
				...
				surfaceDescription.Color = lerpResult43.rgb;
				surfaceDescription.Emission = lerpResult43.rgb;
				surfaceDescription.Alpha = saturate( ( saturate( ( packedInput.ase_color.a * smoothstepResult45 ) ) * distanceDepth36 ) );
		...
		Pass
		{
					...
					)
			{
				...
				float4 tex2DNode16 = tex2D( _Texture, uv_Texture );
				float smoothstepResult45 = smoothstep( packedInput.ase_texcoord.z , ( packedInput.ase_texcoord.z + 1.0 ) , tex2DNode16.a);
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput  ) : SV_Target
			{
				...
				float smoothstepResult45 = smoothstep( packedInput.ase_texcoord2.z , ( packedInput.ase_texcoord2.z + 1.0 ) , tex2DNode16.a);
		...
		Pass
		{
					...
					)
			{
				...
				float4 tex2DNode16 = tex2D( _Texture, uv_Texture );
				float smoothstepResult45 = smoothstep( packedInput.ase_texcoord3.z , ( packedInput.ase_texcoord3.z + 1.0 ) , tex2DNode16.a);
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;56;0,0;Float;False;True;-1;2;Rendering.HighDefinition.HDUnlitGUI;0;15;Vefects/SH_Vefects_VFX_HDRP_Water_Mist_01;7f5cb9c3ea6481f469fdd856555439ef;True;Forward Unlit;0;0;Forward Unlit;9;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Transparent=Queue=0;True;5;True;7;d3d11;metal;vulkan;xboxone;xboxseries;playstation;switch;0;False;False;False;False;True;3;1;False;;10;False;;0;1;False;;0;False;;False;False;True;1;1;False;;0;True;_DstBlend2;0;1;False;;0;False;;False;False;True;1;1;False;;0;True;_DstBlend2;0;1;False;;0;False;;False;False;False;True;0;True;_CullModeForward;False;False;False;True;True;True;True;True;0;True;_ColorMaskTransparentVel;False;False;False;False;False;True;True;0;True;_StencilRef;255;False;;255;True;_StencilWriteMask;7;False;;3;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;0;True;_ZWrite;True;0;True;_ZTestDepthEqualForOpaque;False;True;1;LightMode=ForwardOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;30;Surface Type;1;638800691119772250;  Rendering Pass ;0;0;  Rendering Pass;1;0;  Blending Mode;0;0;  Receive Fog;1;0;  Distortion;0;0;    Distortion Mode;0;0;    Distortion Only;1;0;  Depth Write;0;638800691229242968;  Cull Mode;0;0;  Depth Test;4;0;Double-Sided;0;0;Alpha Clipping;0;0;Receive Decals;0;638800691274398178;Motion Vectors;1;0;  Add Precomputed Velocity;0;0;Shadow Matte;0;0;Cast Shadows;1;0;GPU Instancing;1;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position,InvertActionOnDeselection;1;0;LOD CrossFade;0;0;0;8;True;True;True;True;True;True;False;True;False;;False;0
...
ASEEND*/
//CHKSM=08A6DC07E20FB1B1CB9D0F686994717F3BBE071B
...
Shader "Vefects/SH_Vefects_VFX_HDRP_Waterfall_01"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float2 texCoord1_g44 = inputMesh.ase_texcoord * float2( 1,1 ) + float2( 0,0 );
				...
				float3 objToWorldDir399 = mul( GetObjectToWorldMatrix(), float4( inputMesh.normalOS, 0 ) ).xyz;
				float2 texCoord404 = inputMesh.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float3 customSurfaceDepth111 = inputMesh.positionOS;
				float customEye111 = -TransformWorldToView(TransformObjectToWorld(customSurfaceDepth111)).z;
				outputPackedVaryingsMeshToPS.ase_texcoord7.w = customEye111;
						...
						)
			{
				...
				float2 panSpeed424 = _PanSpeed;
				float2 appendResult460 = (float2((( panSpeed424 * 0.05 )).x , (panSpeed424).y));
				float2 texCoord1_g45 = packedInput.ase_texcoord6.xy * float2( 1,1 ) + float2( 0,0 );
				float3 waterfallScale375 = _WaterfallScale;
				float temp_output_444_0 = ( _NoiseTiling * (waterfallScale375).x );
				float temp_output_445_0 = ( _NoiseTiling * (waterfallScale375).y );
				...
				float2 texCoord1_g44 = packedInput.ase_texcoord6.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult4_g44 = (float2(( temp_output_444_0 * 1.67 ) , ( temp_output_445_0 * 1.67 )));
				float2 appendResult5_g44 = (float2(0.0 , 0.0));
				float2 panner453 = ( 1.0 * _Time.y * ( appendResult460 * 0.7 ) + ( float3( ( ( texCoord1_g44 * appendResult4_g44 ) + appendResult5_g44 ) ,  0.0 ) + float3( 0,0,0 ) ).xy);
				...
				float2 texCoord1_g46 = packedInput.ase_texcoord6.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float2 texCoord367 = packedInput.ase_texcoord6.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float gangnamStyle410 = saturate( ( ( tex2D( _WaterfallMask, ( panner422 + random363 ) ).g * ( packedInput.ase_color.r * ( 1.0 - temp_output_383_0 ) ) ) - saturate( ( ( packedInput.ase_color.g * temp_output_465_0 ) + ( temp_output_383_0 * temp_output_465_0 ) ) ) ) );
				...
				float lerpResult3_g51 = lerp( ( -1.0 * temp_output_4_0_g51 ) , temp_output_4_0_g51 , isFrontFace);
				...
				float customEye111 = packedInput.ase_texcoord7.w;
				float cameraDepthFade111 = (( customEye111 -_ProjectionParams.y - _CameraDepthFadeOffset ) / _CameraDepthFadeLength);
				float op62 = saturate( ( saturate( ( saturate( ( saturate( ( saturate( ( gangnamStyle410 * _OpacityMult ) ) * distanceDepth36 ) ) * ( 1.0 - fresnelNode1_g51 ) ) ) * saturate( cameraDepthFade111 ) ) ) * packedInput.ase_color.a ) );
				float4 fetchOpaqueVal23 = ASEHDSampleSceneColor(( (ase_screenPosNorm).xy + ( ( ( (norm100).xy + -0.5 ) * 2.0 ) * ( _NormalDistortionIntensity * op62 ) ) ), 0.0, GetInverseCurrentExposureMultiplier());
				float4 temp_output_481_0 = ( fetchOpaqueVal23 * 0.0001 );
				float4 lerpResult24 = lerp( temp_output_481_0 , ( float4( _Color01 , 0.0 ) + temp_output_481_0 ) , _ColorStrength);
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				float2 panSpeed424 = _PanSpeed;
				float2 appendResult460 = (float2((( panSpeed424 * 0.05 )).x , (panSpeed424).y));
				float2 texCoord1_g44 = inputMesh.uv0.xy * float2( 1,1 ) + float2( 0,0 );
				float3 waterfallScale375 = _WaterfallScale;
				float temp_output_444_0 = ( _NoiseTiling * (waterfallScale375).x );
				float temp_output_445_0 = ( _NoiseTiling * (waterfallScale375).y );
				float2 appendResult4_g44 = (float2(( temp_output_444_0 * 1.67 ) , ( temp_output_445_0 * 1.67 )));
				...
				float4 tex2DNode395 = tex2Dlod( _WaterfallNoise, float4( panner453, 0, 0.0) );
				float3 objToWorldDir399 = mul( GetObjectToWorldMatrix(), float4( inputMesh.normalOS, 0 ) ).xyz;
				float2 texCoord404 = inputMesh.uv0.xy * float2( 1,1 ) + float2( 0,0 );
				float3 WPO407 = ( ( ( ( tex2DNode395.g + -0.5 ) * 2.0 ) * objToWorldDir399 ) * ( _WPOStrength * saturate( ( 1.0 - texCoord404.y ) ) ) );
				...
				float3 customSurfaceDepth111 = inputMesh.positionOS;
				float customEye111 = -TransformWorldToView(TransformObjectToWorld(customSurfaceDepth111)).z;
				outputPackedVaryingsMeshToPS.ase_texcoord4.w = customEye111;
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 panSpeed424 = _PanSpeed;
				float2 appendResult460 = (float2((( panSpeed424 * 0.05 )).x , (panSpeed424).y));
				float2 texCoord1_g45 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float3 waterfallScale375 = _WaterfallScale;
				float temp_output_444_0 = ( _NoiseTiling * (waterfallScale375).x );
				float temp_output_445_0 = ( _NoiseTiling * (waterfallScale375).y );
				float2 appendResult4_g45 = (float2(temp_output_444_0 , temp_output_445_0));
				float2 appendResult5_g45 = (float2(0.0 , 0.0));
				float2 panner452 = ( 1.0 * _Time.y * appendResult460 + ( float3( ( ( texCoord1_g45 * appendResult4_g45 ) + appendResult5_g45 ) ,  0.0 ) + float3( 0,0,0 ) ).xy);
				float2 texCoord1_g44 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult4_g44 = (float2(( temp_output_444_0 * 1.67 ) , ( temp_output_445_0 * 1.67 )));
				float2 appendResult5_g44 = (float2(0.0 , 0.0));
				float2 panner453 = ( 1.0 * _Time.y * ( appendResult460 * 0.7 ) + ( float3( ( ( texCoord1_g44 * appendResult4_g44 ) + appendResult5_g44 ) ,  0.0 ) + float3( 0,0,0 ) ).xy);
				float3 lerpResult235 = lerp( float3(0,0,1) , ( tex2D( _WaterfallNormal, panner452 ).rgb + tex2D( _WaterfallNormal, panner453 ).rgb ) , _NormalIntensity);
				...
				float2 temp_output_426_0 = ( panSpeed424 * 2.0 );
				float2 appendResult432 = (float2((( temp_output_426_0 * 0.1 )).x , (temp_output_426_0).y));
				float2 texCoord1_g46 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult4_g46 = (float2(( _MaskTilingX * (waterfallScale375).x ) , ( (waterfallScale375).y * _MaskTilingY )));
				float2 appendResult5_g46 = (float2(0.0 , 0.0));
				float2 panner422 = ( 1.0 * _Time.y * appendResult432 + ( float3( ( ( texCoord1_g46 * appendResult4_g46 ) + appendResult5_g46 ) ,  0.0 ) + float3( 0,0,0 ) ).xy);
				float random363 = packedInput.ase_texcoord3.z;
				float2 texCoord367 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float temp_output_383_0 = saturate( (0.0 + (saturate( abs( ( ( texCoord367.x + -0.5 ) * 2.0 ) ) ) - ( 1.0 - ( 1.0 / ( ( (waterfallScale375).y / 6.0 ) * 4.0 ) ) )) * (1.0 - 0.0) / (1.0 - ( 1.0 - ( 1.0 / ( ( (waterfallScale375).y / 6.0 ) * 4.0 ) ) ))) );
				float4 tex2DNode395 = tex2D( _WaterfallNoise, panner453 );
				float temp_output_465_0 = saturate( ( tex2D( _WaterfallNoise, panner452 ).g * tex2DNode395.g ) );
				float gangnamStyle410 = saturate( ( ( tex2D( _WaterfallMask, ( panner422 + random363 ) ).g * ( packedInput.ase_color.r * ( 1.0 - temp_output_383_0 ) ) ) - saturate( ( ( packedInput.ase_color.g * temp_output_465_0 ) + ( temp_output_383_0 * temp_output_465_0 ) ) ) ) );
				...
				float fresnelNdotV1_g51 = dot( float3(dot(tanToWorld0,tanNormal1_g51), dot(tanToWorld1,tanNormal1_g51), dot(tanToWorld2,tanNormal1_g51)), ase_viewDirWS );
				float fresnelNode1_g51 = ( _FresnelBias + _FresnelScale * pow( 1.0 - fresnelNdotV1_g51, lerpResult3_g51 ) );
				float customEye111 = packedInput.ase_texcoord4.w;
				float cameraDepthFade111 = (( customEye111 -_ProjectionParams.y - _CameraDepthFadeOffset ) / _CameraDepthFadeLength);
				float op62 = saturate( ( saturate( ( saturate( ( saturate( ( saturate( ( gangnamStyle410 * _OpacityMult ) ) * distanceDepth36 ) ) * ( 1.0 - fresnelNode1_g51 ) ) ) * saturate( cameraDepthFade111 ) ) ) * packedInput.ase_color.a ) );
				float4 fetchOpaqueVal23 = ASEHDSampleSceneColor(( (ase_screenPosNorm).xy + ( ( ( (norm100).xy + -0.5 ) * 2.0 ) * ( _NormalDistortionIntensity * op62 ) ) ), 0.0, GetInverseCurrentExposureMultiplier());
				float4 temp_output_481_0 = ( fetchOpaqueVal23 * 0.0001 );
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float3 customSurfaceDepth111 = inputMesh.positionOS;
				float customEye111 = -TransformWorldToView(TransformObjectToWorld(customSurfaceDepth111)).z;
				outputPackedVaryingsMeshToPS.ase_texcoord3.w = customEye111;
			...
			UNITY_SETUP_INSTANCE_ID(packedInput);
				...
				float2 temp_output_426_0 = ( panSpeed424 * 2.0 );
				float2 appendResult432 = (float2((( temp_output_426_0 * 0.1 )).x , (temp_output_426_0).y));
				float2 texCoord1_g46 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float3 waterfallScale375 = _WaterfallScale;
				float2 appendResult4_g46 = (float2(( _MaskTilingX * (waterfallScale375).x ) , ( (waterfallScale375).y * _MaskTilingY )));
				float2 appendResult5_g46 = (float2(0.0 , 0.0));
				float2 panner422 = ( 1.0 * _Time.y * appendResult432 + ( float3( ( ( texCoord1_g46 * appendResult4_g46 ) + appendResult5_g46 ) ,  0.0 ) + float3( 0,0,0 ) ).xy);
				float random363 = packedInput.ase_texcoord1.z;
				float2 texCoord367 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float temp_output_383_0 = saturate( (0.0 + (saturate( abs( ( ( texCoord367.x + -0.5 ) * 2.0 ) ) ) - ( 1.0 - ( 1.0 / ( ( (waterfallScale375).y / 6.0 ) * 4.0 ) ) )) * (1.0 - 0.0) / (1.0 - ( 1.0 - ( 1.0 / ( ( (waterfallScale375).y / 6.0 ) * 4.0 ) ) ))) );
				float2 appendResult460 = (float2((( panSpeed424 * 0.05 )).x , (panSpeed424).y));
				float2 texCoord1_g45 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float temp_output_444_0 = ( _NoiseTiling * (waterfallScale375).x );
				float temp_output_445_0 = ( _NoiseTiling * (waterfallScale375).y );
				float2 appendResult4_g45 = (float2(temp_output_444_0 , temp_output_445_0));
				float2 appendResult5_g45 = (float2(0.0 , 0.0));
				float2 panner452 = ( 1.0 * _Time.y * appendResult460 + ( float3( ( ( texCoord1_g45 * appendResult4_g45 ) + appendResult5_g45 ) ,  0.0 ) + float3( 0,0,0 ) ).xy);
				float2 texCoord1_g44 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult4_g44 = (float2(( temp_output_444_0 * 1.67 ) , ( temp_output_445_0 * 1.67 )));
				float2 appendResult5_g44 = (float2(0.0 , 0.0));
				float2 panner453 = ( 1.0 * _Time.y * ( appendResult460 * 0.7 ) + ( float3( ( ( texCoord1_g44 * appendResult4_g44 ) + appendResult5_g44 ) ,  0.0 ) + float3( 0,0,0 ) ).xy);
				float4 tex2DNode395 = tex2D( _WaterfallNoise, panner453 );
				...
				float fresnelNdotV1_g51 = dot( float3(dot(tanToWorld0,tanNormal1_g51), dot(tanToWorld1,tanNormal1_g51), dot(tanToWorld2,tanNormal1_g51)), ase_viewDirWS );
				float fresnelNode1_g51 = ( _FresnelBias + _FresnelScale * pow( 1.0 - fresnelNdotV1_g51, lerpResult3_g51 ) );
				float customEye111 = packedInput.ase_texcoord3.w;
				float cameraDepthFade111 = (( customEye111 -_ProjectionParams.y - _CameraDepthFadeOffset ) / _CameraDepthFadeLength);
				float op62 = saturate( ( saturate( ( saturate( ( saturate( ( saturate( ( gangnamStyle410 * _OpacityMult ) ) * distanceDepth36 ) ) * ( 1.0 - fresnelNode1_g51 ) ) ) * saturate( cameraDepthFade111 ) ) ) * packedInput.ase_color.a ) );
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float3 customSurfaceDepth111 = inputMesh.positionOS;
				float customEye111 = -TransformWorldToView(TransformObjectToWorld(customSurfaceDepth111)).z;
				outputPackedVaryingsMeshToPS.ase_texcoord5.w = customEye111;
			...
			UNITY_SETUP_INSTANCE_ID(packedInput);
				...
				float fresnelNdotV1_g51 = dot( float3(dot(tanToWorld0,tanNormal1_g51), dot(tanToWorld1,tanNormal1_g51), dot(tanToWorld2,tanNormal1_g51)), ase_viewDirWS );
				float fresnelNode1_g51 = ( _FresnelBias + _FresnelScale * pow( 1.0 - fresnelNdotV1_g51, lerpResult3_g51 ) );
				float customEye111 = packedInput.ase_texcoord5.w;
				float cameraDepthFade111 = (( customEye111 -_ProjectionParams.y - _CameraDepthFadeOffset ) / _CameraDepthFadeLength);
				float op62 = saturate( ( saturate( ( saturate( ( saturate( ( saturate( ( gangnamStyle410 * _OpacityMult ) ) * distanceDepth36 ) ) * ( 1.0 - fresnelNode1_g51 ) ) ) * saturate( cameraDepthFade111 ) ) ) * packedInput.ase_color.a ) );
		...
		Pass
		{
			...
			AttributesMesh ApplyMeshModification(AttributesMesh inputMesh, float3 timeParameters, inout PackedVaryingsMeshToPS outputPackedVaryingsMeshToPS )
			{
				...
				float3 customSurfaceDepth111 = inputMesh.positionOS;
				float customEye111 = -TransformWorldToView(TransformObjectToWorld(customSurfaceDepth111)).z;
				outputPackedVaryingsMeshToPS.ase_texcoord9.w = customEye111;
						...
						)
			{
				...
				float2 panSpeed424 = _PanSpeed;
				float2 appendResult460 = (float2((( panSpeed424 * 0.05 )).x , (panSpeed424).y));
				float2 texCoord1_g45 = packedInput.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				float3 waterfallScale375 = _WaterfallScale;
				float temp_output_444_0 = ( _NoiseTiling * (waterfallScale375).x );
				float temp_output_445_0 = ( _NoiseTiling * (waterfallScale375).y );
				float2 appendResult4_g45 = (float2(temp_output_444_0 , temp_output_445_0));
				float2 appendResult5_g45 = (float2(0.0 , 0.0));
				float2 panner452 = ( 1.0 * _Time.y * appendResult460 + ( float3( ( ( texCoord1_g45 * appendResult4_g45 ) + appendResult5_g45 ) ,  0.0 ) + float3( 0,0,0 ) ).xy);
				float2 texCoord1_g44 = packedInput.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult4_g44 = (float2(( temp_output_444_0 * 1.67 ) , ( temp_output_445_0 * 1.67 )));
				float2 appendResult5_g44 = (float2(0.0 , 0.0));
				float2 panner453 = ( 1.0 * _Time.y * ( appendResult460 * 0.7 ) + ( float3( ( ( texCoord1_g44 * appendResult4_g44 ) + appendResult5_g44 ) ,  0.0 ) + float3( 0,0,0 ) ).xy);
				float3 lerpResult235 = lerp( float3(0,0,1) , ( tex2D( _WaterfallNormal, panner452 ).rgb + tex2D( _WaterfallNormal, panner453 ).rgb ) , _NormalIntensity);
				...
				float2 temp_output_426_0 = ( panSpeed424 * 2.0 );
				float2 appendResult432 = (float2((( temp_output_426_0 * 0.1 )).x , (temp_output_426_0).y));
				float2 texCoord1_g46 = packedInput.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult4_g46 = (float2(( _MaskTilingX * (waterfallScale375).x ) , ( (waterfallScale375).y * _MaskTilingY )));
				float2 appendResult5_g46 = (float2(0.0 , 0.0));
				float2 panner422 = ( 1.0 * _Time.y * appendResult432 + ( float3( ( ( texCoord1_g46 * appendResult4_g46 ) + appendResult5_g46 ) ,  0.0 ) + float3( 0,0,0 ) ).xy);
				float random363 = packedInput.ase_texcoord8.z;
				float2 texCoord367 = packedInput.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				float temp_output_383_0 = saturate( (0.0 + (saturate( abs( ( ( texCoord367.x + -0.5 ) * 2.0 ) ) ) - ( 1.0 - ( 1.0 / ( ( (waterfallScale375).y / 6.0 ) * 4.0 ) ) )) * (1.0 - 0.0) / (1.0 - ( 1.0 - ( 1.0 / ( ( (waterfallScale375).y / 6.0 ) * 4.0 ) ) ))) );
				float4 tex2DNode395 = tex2D( _WaterfallNoise, panner453 );
				float temp_output_465_0 = saturate( ( tex2D( _WaterfallNoise, panner452 ).g * tex2DNode395.g ) );
				float gangnamStyle410 = saturate( ( ( tex2D( _WaterfallMask, ( panner422 + random363 ) ).g * ( packedInput.ase_color.r * ( 1.0 - temp_output_383_0 ) ) ) - saturate( ( ( packedInput.ase_color.g * temp_output_465_0 ) + ( temp_output_383_0 * temp_output_465_0 ) ) ) ) );
				...
				float fresnelNdotV1_g51 = dot( float3(dot(tanToWorld0,tanNormal1_g51), dot(tanToWorld1,tanNormal1_g51), dot(tanToWorld2,tanNormal1_g51)), ase_viewDirWS );
				float fresnelNode1_g51 = ( _FresnelBias + _FresnelScale * pow( 1.0 - fresnelNdotV1_g51, lerpResult3_g51 ) );
				float customEye111 = packedInput.ase_texcoord9.w;
				float cameraDepthFade111 = (( customEye111 -_ProjectionParams.y - _CameraDepthFadeOffset ) / _CameraDepthFadeLength);
				float op62 = saturate( ( saturate( ( saturate( ( saturate( ( saturate( ( gangnamStyle410 * _OpacityMult ) ) * distanceDepth36 ) ) * ( 1.0 - fresnelNode1_g51 ) ) ) * saturate( cameraDepthFade111 ) ) ) * packedInput.ase_color.a ) );
				float4 fetchOpaqueVal23 = ASEHDSampleSceneColor(( (ase_screenPosNorm).xy + ( ( ( (norm100).xy + -0.5 ) * 2.0 ) * ( _NormalDistortionIntensity * op62 ) ) ), 0.0, GetInverseCurrentExposureMultiplier());
				float4 temp_output_481_0 = ( fetchOpaqueVal23 * 0.0001 );
		...
		Pass
        {
			...
			UNITY_SETUP_INSTANCE_ID(packedInput);
				...
				float2 temp_output_426_0 = ( panSpeed424 * 2.0 );
				float2 appendResult432 = (float2((( temp_output_426_0 * 0.1 )).x , (temp_output_426_0).y));
				float2 texCoord1_g46 = packedInput.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float3 waterfallScale375 = _WaterfallScale;
				float2 appendResult4_g46 = (float2(( _MaskTilingX * (waterfallScale375).x ) , ( (waterfallScale375).y * _MaskTilingY )));
				float2 appendResult5_g46 = (float2(0.0 , 0.0));
				float2 panner422 = ( 1.0 * _Time.y * appendResult432 + ( float3( ( ( texCoord1_g46 * appendResult4_g46 ) + appendResult5_g46 ) ,  0.0 ) + float3( 0,0,0 ) ).xy);
				float random363 = packedInput.ase_texcoord7.z;
				float2 texCoord367 = packedInput.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float temp_output_383_0 = saturate( (0.0 + (saturate( abs( ( ( texCoord367.x + -0.5 ) * 2.0 ) ) ) - ( 1.0 - ( 1.0 / ( ( (waterfallScale375).y / 6.0 ) * 4.0 ) ) )) * (1.0 - 0.0) / (1.0 - ( 1.0 - ( 1.0 / ( ( (waterfallScale375).y / 6.0 ) * 4.0 ) ) ))) );
				float2 appendResult460 = (float2((( panSpeed424 * 0.05 )).x , (panSpeed424).y));
				float2 texCoord1_g45 = packedInput.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float temp_output_444_0 = ( _NoiseTiling * (waterfallScale375).x );
				float temp_output_445_0 = ( _NoiseTiling * (waterfallScale375).y );
				float2 appendResult4_g45 = (float2(temp_output_444_0 , temp_output_445_0));
				float2 appendResult5_g45 = (float2(0.0 , 0.0));
				float2 panner452 = ( 1.0 * _Time.y * appendResult460 + ( float3( ( ( texCoord1_g45 * appendResult4_g45 ) + appendResult5_g45 ) ,  0.0 ) + float3( 0,0,0 ) ).xy);
				float2 texCoord1_g44 = packedInput.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult4_g44 = (float2(( temp_output_444_0 * 1.67 ) , ( temp_output_445_0 * 1.67 )));
				float2 appendResult5_g44 = (float2(0.0 , 0.0));
				float2 panner453 = ( 1.0 * _Time.y * ( appendResult460 * 0.7 ) + ( float3( ( ( texCoord1_g44 * appendResult4_g44 ) + appendResult5_g44 ) ,  0.0 ) + float3( 0,0,0 ) ).xy);
				float4 tex2DNode395 = tex2D( _WaterfallNoise, panner453 );
...
WireConnection;481;0;23;0
WireConnection;481;1;482;0
WireConnection;470;0;24;0
WireConnection;470;1;101;0
WireConnection;470;5;104;0
WireConnection;470;6;102;0
WireConnection;470;7;105;0
WireConnection;470;9;63;0
WireConnection;470;11;408;0
ASEEND*/
//CHKSM=7776D4C1008800FDEA80E4B40BD1493E4977C43E
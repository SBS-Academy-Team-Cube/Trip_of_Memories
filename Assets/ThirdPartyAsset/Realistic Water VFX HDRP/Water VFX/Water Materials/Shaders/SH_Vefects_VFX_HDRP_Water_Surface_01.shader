...
Shader "Vefects/SH_Vefects_VFX_HDRP_Water_Surface_01"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				outputPackedVaryingsMeshToPS.ase_texcoord6.z = customEye170;
						...
						)
			{
				...
				float screenDepth324 = LinearEyeDepth(SampleCameraDepth( ase_screenPosNorm.xy ),_ZBufferParams);
				...
				float screenDepth300 = LinearEyeDepth(SampleCameraDepth( ase_screenPosNorm.xy ),_ZBufferParams);
				...
				float2 texCoord128 = packedInput.ase_texcoord6.xy * float2( 1,1 ) + float2( 0,0 );
				#ifdef _USEMESHUVS_ON
				float2 staticSwitch130 = texCoord128;
				#else
				float2 staticSwitch130 = ( (ase_worldPos).xz / _WavesScale );
				#endif
				...
				float2 UVNoiseUV117 = ( (ase_worldPos).xz / _UVNoiseScale );
				...
				float lerpResult3_g69 = lerp( ( -1.0 * temp_output_4_0_g69 ) , temp_output_4_0_g69 , isFrontFace);
				...
				float4 temp_output_328_0 = ( ( ( float4( lerpResult319 , 0.0 ) * packedInput.ase_color ) * ( fetchOpaqueVal23 * 0.0001 ) ) * float4( _ColorOverallTint.rgb , 0.0 ) );
				
				float2 temp_output_220_0 = ( (ase_worldPos).xz / _SpecsScale );
				...
				float3 AtmosphericLightVector253 = SafeNormalize(-_DirectionalLightDatas[0].forward);
				float3 ase_viewDirSafeWS = SafeNormalize( ase_viewVectorWS );
				float3 normalizeResult250 = ASESafeNormalize( reflect( ( 1.0 - ase_viewDirSafeWS ) , normalWS ) );
				...
				float3 temp_cast_21 = (spec84).xxx;
				...
				float lerpResult3_g65 = lerp( ( -1.0 * temp_output_4_0_g65 ) , temp_output_4_0_g65 , isFrontFace);
				...
				float customEye170 = packedInput.ase_texcoord6.z;
				...
				surfaceDescription.BaseColor = temp_output_328_0.rgb;
				...
				surfaceDescription.Emission = ( temp_output_328_0 * _Emission ).rgb;
				surfaceDescription.Smoothness = smoothness90;
				surfaceDescription.Occlusion = 1;
				surfaceDescription.Alpha = saturate( ( packedInput.ase_color.a * saturate( ( saturate( ( DF59 * DSFres181 ) ) * camDF183 ) ) ) );
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				float3 customSurfaceDepth170 = inputMesh.positionOS;
				float customEye170 = -TransformWorldToView(TransformObjectToWorld(customSurfaceDepth170)).z;
				outputPackedVaryingsMeshToPS.ase_texcoord3.w = customEye170;
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 texCoord128 = packedInput.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
				#ifdef _USEMESHUVS_ON
				float2 staticSwitch130 = texCoord128;
				#else
				float2 staticSwitch130 = ( (ase_worldPos).xz / _WavesScale );
				...
				float3 AtmosphericLightVector253 = SafeNormalize(-_DirectionalLightDatas[0].forward);
				float3 ase_viewDirSafeWS = SafeNormalize( ase_viewVectorWS );
				float3 normalizeResult250 = ASESafeNormalize( reflect( ( 1.0 - ase_viewDirSafeWS ) , ase_worldNormal ) );
				float3 ReflectionVector251 = normalizeResult250;
				float dotResult258 = dot( AtmosphericLightVector253 , ReflectionVector251 );
				float dotResult268 = dot( AtmosphericLightVector253 , ReflectionVector251 );
				float dotResult274 = dot( AtmosphericLightVector253 , ReflectionVector251 );
				...
				float temp_output_178_0 = fresnelNode1_g65;
				float DSFres181 = saturate( temp_output_178_0 );
				float customEye170 = packedInput.ase_texcoord3.w;
				float cameraDepthFade170 = (( customEye170 -_ProjectionParams.y - _CameraDepthFadeOffset ) / _CameraDepthFadeLength);
				float camDF183 = saturate( cameraDepthFade170 );
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float3 customSurfaceDepth170 = inputMesh.positionOS;
				float customEye170 = -TransformWorldToView(TransformObjectToWorld(customSurfaceDepth170)).z;
				outputPackedVaryingsMeshToPS.ase_texcoord3.z = customEye170;
			...
			UNITY_SETUP_INSTANCE_ID(packedInput);
				...
				float3 ase_worldPos = GetAbsolutePositionWS( positionRWS );
				float2 texCoord128 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				#ifdef _USEMESHUVS_ON
				float2 staticSwitch130 = texCoord128;
				#else
				float2 staticSwitch130 = ( (ase_worldPos).xz / _WavesScale );
				...
				float temp_output_178_0 = fresnelNode1_g65;
				float DSFres181 = saturate( temp_output_178_0 );
				float customEye170 = packedInput.ase_texcoord3.z;
				float cameraDepthFade170 = (( customEye170 -_ProjectionParams.y - _CameraDepthFadeOffset ) / _CameraDepthFadeLength);
				float camDF183 = saturate( cameraDepthFade170 );
		...
		Pass
		{
			...
			AttributesMesh ApplyMeshModification(AttributesMesh inputMesh, float3 timeParameters, inout PackedVaryingsMeshToPS outputPackedVaryingsMeshToPS )
			{
				...
				float3 customSurfaceDepth170 = inputMesh.positionOS;
				float customEye170 = -TransformWorldToView(TransformObjectToWorld(customSurfaceDepth170)).z;
				outputPackedVaryingsMeshToPS.ase_texcoord8.z = customEye170;
						...
						)
			{
				...
				float temp_output_305_0 = saturate( ( saturate( pow( saturate( distanceDepth300 ) , _FoamDFPower ) ) * _FoamDFMultiply ) );
				float3 ase_worldPos = GetAbsolutePositionWS( positionRWS );
				float2 texCoord128 = packedInput.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				#ifdef _USEMESHUVS_ON
				float2 staticSwitch130 = texCoord128;
				#else
				float2 staticSwitch130 = ( (ase_worldPos).xz / _WavesScale );
				...
				float temp_output_178_0 = fresnelNode1_g65;
				float DSFres181 = saturate( temp_output_178_0 );
				float customEye170 = packedInput.ase_texcoord8.z;
				float cameraDepthFade170 = (( customEye170 -_ProjectionParams.y - _CameraDepthFadeOffset ) / _CameraDepthFadeLength);
				float camDF183 = saturate( cameraDepthFade170 );
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;39;-896,-384;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;328;-640,-384;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT3;0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;330;-640,-256;Inherit;False;Property;_ColorOverallTint;Color Overall Tint;4;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;347;-896,0;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;348;-908.5297,116.3043;Inherit;False;Constant;_Float1;Float 1;51;0;Create;True;0;0;0;False;0;False;0.0001;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;336;0,0;Float;False;True;-1;2;Rendering.HighDefinition.LightingShaderGraphGUI;0;14;Vefects/SH_Vefects_VFX_HDRP_Water_Surface_01;53b46d85872c5b24c8f4f0a1c3fe4c87;True;GBuffer;0;0;GBuffer;34;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;5;True;7;d3d11;metal;vulkan;xboxone;xboxseries;playstation;switch;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;0;True;_CullMode;False;False;False;False;False;False;False;False;False;True;True;0;True;_StencilRefGBuffer;255;False;;255;True;_StencilWriteMaskGBuffer;7;False;;3;False;;0;False;;0;False;;7;False;;3;False;;0;False;;0;False;;False;False;True;0;True;_ZTestGBuffer;False;True;1;LightMode=GBuffer;False;False;0;;0;0;Standard;38;Surface Type;1;638800687040543117;  Rendering Pass;1;0;  Refraction Model;0;0;    Blending Mode;0;0;    Blend Preserves Specular;0;638800687430860582;  Back Then Front Rendering;0;0;  Transparent Depth Prepass;0;0;  Transparent Depth Postpass;0;0;  ZWrite;0;0;  Z Test;4;0;Double-Sided;1;638800690185358587;Alpha Clipping;0;0;  Use Shadow Threshold;0;0;Material Type,InvertActionOnDeselection;4;638800687062415382;  Energy Conserving Specular;0;638800687423194691;  Transmission,InvertActionOnDeselection;0;0;Receive Decals;0;638800687419798081;Receive SSR;1;0;Receive SSR Transparent;0;0;Motion Vectors;1;0;  Add Precomputed Velocity;0;0;Specular AA;0;0;Specular Occlusion Mode;1;0;Override Baked GI;0;0;Depth Offset;0;0;  Conserative;1;0;GPU Instancing;1;0;LOD CrossFade;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position;1;0;0;11;True;True;True;True;True;True;False;False;False;True;True;False;;False;0
...
WireConnection;39;1;347;0
WireConnection;328;0;39;0
WireConnection;328;1;330;5
WireConnection;347;0;23;0
WireConnection;347;1;348;0
WireConnection;336;0;328;0
WireConnection;336;1;79;0
WireConnection;336;5;85;0
WireConnection;336;6;331;0
WireConnection;336;7;91;0
WireConnection;336;9;186;0
ASEEND*/
//CHKSM=D6549CCF14C3F4AD88D279D14F203A39B8E49830

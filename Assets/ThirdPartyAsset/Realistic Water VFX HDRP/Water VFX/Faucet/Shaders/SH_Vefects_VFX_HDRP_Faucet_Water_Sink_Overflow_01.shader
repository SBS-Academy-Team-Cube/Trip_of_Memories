...
Shader "Vefects/SH_Vefects_VFX_HDRP_Faucet_Water_Sink_Overflow_01"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 texCoord338 = packedInput.ase_texcoord6.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner148 = ( 1.0 * _Time.y * _Water01PanSpeed + ( texCoord338 * _Water01UVScale ));
				float2 texCoord344 = packedInput.ase_texcoord6.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner143 = ( 1.0 * _Time.y * _Water02PanSpeed + ( texCoord344 * _Water02UVScale ));
				float2 texCoord347 = packedInput.ase_texcoord6.xy * float2( 1,1 ) + float2( 0,0 );
				float4 vMask354 = ( saturate( ( saturate( pow( saturate( texCoord347.y ) , _VerticalMaskPower ) ) * _VerticalMaskMultiply ) ) * packedInput.ase_color );
				...
				surfaceDescription.BaseColor = ( float4( _Color01 , 0.0 ) * ( fetchOpaqueVal23 * 0.0001 ) ).rgb;
				...
				surfaceDescription.Emission = ( _Color01 * _Emission );
				surfaceDescription.Smoothness = smoothness90;
				surfaceDescription.Occlusion = 1;
				surfaceDescription.Alpha = saturate( ( packedInput.ase_color.a * saturate( ( saturate( ( saturate( ( DF59 * DSFres181 ) ) * camDF183 ) ) * vMask354 ) ) ) ).r;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float4 ase_screenPosNorm = screenPos / screenPos.w;
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float2 texCoord338 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner148 = ( 1.0 * _Time.y * _Water01PanSpeed + ( texCoord338 * _Water01UVScale ));
				float2 texCoord344 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner143 = ( 1.0 * _Time.y * _Water02PanSpeed + ( texCoord344 * _Water02UVScale ));
				float2 texCoord347 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float4 vMask354 = ( saturate( ( saturate( pow( saturate( texCoord347.y ) , _VerticalMaskPower ) ) * _VerticalMaskMultiply ) ) * packedInput.ase_color );
				float4 temp_output_346_0 = ( _WaterNormalStrength * vMask354 );
				float3 appendResult138 = (float3(temp_output_346_0.r , temp_output_346_0.r , 1.0));
				float3 WaterNormal140 = ( ( tex2D( _WaterNormal, panner148 ).rgb + tex2D( _WaterNormal, panner143 ).rgb ) * appendResult138 );
		...
		Pass
		{
			...
			UNITY_SETUP_INSTANCE_ID(packedInput);
				...
				float cameraDepthFade170 = (( customEye170 -_ProjectionParams.y - _CameraDepthFadeOffset ) / _CameraDepthFadeLength);
				float camDF183 = saturate( cameraDepthFade170 );
				float2 texCoord347 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				float4 vMask354 = ( saturate( ( saturate( pow( saturate( texCoord347.y ) , _VerticalMaskPower ) ) * _VerticalMaskMultiply ) ) * packedInput.ase_color );
		...
		Pass
		{
						...
						)
			{
				...
				float4 ase_screenPosNorm = screenPos / screenPos.w;
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float2 texCoord338 = packedInput.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner148 = ( 1.0 * _Time.y * _Water01PanSpeed + ( texCoord338 * _Water01UVScale ));
				float2 texCoord344 = packedInput.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner143 = ( 1.0 * _Time.y * _Water02PanSpeed + ( texCoord344 * _Water02UVScale ));
				float2 texCoord347 = packedInput.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				float4 vMask354 = ( saturate( ( saturate( pow( saturate( texCoord347.y ) , _VerticalMaskPower ) ) * _VerticalMaskMultiply ) ) * packedInput.ase_color );
				float4 temp_output_346_0 = ( _WaterNormalStrength * vMask354 );
				float3 appendResult138 = (float3(temp_output_346_0.r , temp_output_346_0.r , 1.0));
				float3 WaterNormal140 = ( ( tex2D( _WaterNormal, panner148 ).rgb + tex2D( _WaterNormal, panner143 ).rgb ) * appendResult138 );
		...
		Pass
        {
			...
			AttributesMesh ApplyMeshModification(AttributesMesh inputMesh, float3 timeParameters, inout PackedVaryingsMeshToPS outputPackedVaryingsMeshToPS )
			{
				...
				outputPackedVaryingsMeshToPS.ase_color = inputMesh.ase_color;
				outputPackedVaryingsMeshToPS.ase_texcoord9.xy = inputMesh.ase_texcoord.xy;
			...
			UNITY_SETUP_INSTANCE_ID(packedInput);
				...
				float cameraDepthFade170 = (( customEye170 -_ProjectionParams.y - _CameraDepthFadeOffset ) / _CameraDepthFadeLength);
				float camDF183 = saturate( cameraDepthFade170 );
				float2 texCoord347 = packedInput.ase_texcoord9.xy * float2( 1,1 ) + float2( 0,0 );
				float4 vMask354 = ( saturate( ( saturate( pow( saturate( texCoord347.y ) , _VerticalMaskPower ) ) * _VerticalMaskMultiply ) ) * packedInput.ase_color );
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;375;-1024,0;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;376;-1024,128;Inherit;False;Constant;_Float0;Float 0;30;0;Create;True;0;0;0;False;0;False;0.0001;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;364;0,0;Float;False;True;-1;2;Rendering.HighDefinition.LightingShaderGraphGUI;0;14;Vefects/SH_Vefects_VFX_HDRP_Faucet_Water_Sink_Overflow_01;53b46d85872c5b24c8f4f0a1c3fe4c87;True;GBuffer;0;0;GBuffer;34;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;5;True;7;d3d11;metal;vulkan;xboxone;xboxseries;playstation;switch;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;0;True;_CullMode;False;False;False;False;False;False;False;False;False;True;True;0;True;_StencilRefGBuffer;255;False;;255;True;_StencilWriteMaskGBuffer;7;False;;3;False;;0;False;;0;False;;7;False;;3;False;;0;False;;0;False;;False;False;True;0;True;_ZTestGBuffer;False;True;1;LightMode=GBuffer;False;False;0;;0;0;Standard;38;Surface Type;1;638800699682557559;  Rendering Pass;1;0;  Refraction Model;0;0;    Blending Mode;0;0;    Blend Preserves Specular;0;638800699693923373;  Back Then Front Rendering;0;0;  Transparent Depth Prepass;0;0;  Transparent Depth Postpass;0;0;  ZWrite;0;0;  Z Test;4;0;Double-Sided;1;638800699881453563;Alpha Clipping;0;0;  Use Shadow Threshold;0;0;Material Type,InvertActionOnDeselection;4;638800699713141902;  Energy Conserving Specular;0;638800699720230961;  Transmission,InvertActionOnDeselection;0;0;Receive Decals;0;638800699728156062;Receive SSR;1;0;Receive SSR Transparent;0;0;Motion Vectors;1;0;  Add Precomputed Velocity;0;0;Specular AA;0;0;Specular Occlusion Mode;1;0;Override Baked GI;0;0;Depth Offset;0;0;  Conserative;1;0;GPU Instancing;1;0;LOD CrossFade;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position;1;0;0;11;True;True;True;True;True;True;False;False;False;True;True;False;;False;0
...
WireConnection;375;0;23;0
WireConnection;375;1;376;0
WireConnection;364;0;39;0
WireConnection;364;1;79;0
WireConnection;364;5;85;0
WireConnection;364;6;331;0
WireConnection;364;7;91;0
WireConnection;364;9;186;0
ASEEND*/
//CHKSM=A6F3255A48051E120D55BF5259AC1730F4B573D9

...
Shader "Vefects/SH_Vefects_VFX_HDRP_Garden_Hose_Stream_01"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 texCoord1_g25 = packedInput.ase_texcoord6.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float op62 = saturate( ( saturate( ( saturate( ( ( saturate( tex2DNode94.a ) * _OpacityMult ) * distanceDepth36 ) ) * saturate( cameraDepthFade111 ) ) ) * packedInput.ase_color.a ) );
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float4 ase_screenPosNorm = screenPos / screenPos.w;
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float2 texCoord1_g25 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult4_g25 = (float2(_TilingX , 1.0));
				float2 appendResult5_g25 = (float2(( _TimeParameters.x * 3.0 ) , 0.0));
				float4 tex2DNode94 = tex2D( _HoseTextureNormal, ( float3( ( ( texCoord1_g25 * appendResult4_g25 ) + appendResult5_g25 ) ,  0.0 ) + float3( 0,0,0 ) ).xy );
				float3 lerpResult235 = lerp( float3(0,0,1) , tex2DNode94.rgb , _NormalIntensity);
		...
		Pass
		{
			...
			UNITY_SETUP_INSTANCE_ID(packedInput);
				...
				float2 texCoord1_g25 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult4_g25 = (float2(_TilingX , 1.0));
				float2 appendResult5_g25 = (float2(( _TimeParameters.x * 3.0 ) , 0.0));
				float4 tex2DNode94 = tex2D( _HoseTextureNormal, ( float3( ( ( texCoord1_g25 * appendResult4_g25 ) + appendResult5_g25 ) ,  0.0 ) + float3( 0,0,0 ) ).xy );
				float4 screenPos = packedInput.ase_texcoord2;
		...
		Pass
		{
						...
						)
			{
				...
				float4 ase_screenPosNorm = screenPos / screenPos.w;
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float2 texCoord1_g25 = packedInput.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult4_g25 = (float2(_TilingX , 1.0));
				float2 appendResult5_g25 = (float2(( _TimeParameters.x * 3.0 ) , 0.0));
				float4 tex2DNode94 = tex2D( _HoseTextureNormal, ( float3( ( ( texCoord1_g25 * appendResult4_g25 ) + appendResult5_g25 ) ,  0.0 ) + float3( 0,0,0 ) ).xy );
				float3 lerpResult235 = lerp( float3(0,0,1) , tex2DNode94.rgb , _NormalIntensity);
		...
		Pass
        {
			...
			UNITY_SETUP_INSTANCE_ID(packedInput);
				...
				float2 texCoord1_g25 = packedInput.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult4_g25 = (float2(_TilingX , 1.0));
				float2 appendResult5_g25 = (float2(( _TimeParameters.x * 3.0 ) , 0.0));
				float4 tex2DNode94 = tex2D( _HoseTextureNormal, ( float3( ( ( texCoord1_g25 * appendResult4_g25 ) + appendResult5_g25 ) ,  0.0 ) + float3( 0,0,0 ) ).xy );
...
WireConnection;291;0;24;0
WireConnection;291;1;101;0
WireConnection;291;5;104;0
WireConnection;291;6;102;0
WireConnection;291;7;105;0
WireConnection;291;9;63;0
ASEEND*/
//CHKSM=9EA65C56892B6D2EF1BC44BA3C3E811857976B80

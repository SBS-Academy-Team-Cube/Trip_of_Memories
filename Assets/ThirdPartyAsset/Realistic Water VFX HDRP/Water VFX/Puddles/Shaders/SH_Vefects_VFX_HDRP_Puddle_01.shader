...
Shader "Vefects/SH_Vefects_VFX_HDRP_Puddle_01"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float3 customSurfaceDepth170 = inputMesh.positionOS;
				float customEye170 = -TransformWorldToView(TransformObjectToWorld(customSurfaceDepth170)).z;
				outputPackedVaryingsMeshToPS.ase_texcoord7.w = customEye170;
						...
						)
			{
				...
				float2 texCoord437 = packedInput.ase_texcoord6.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float2 texCoord423 = packedInput.ase_texcoord6.xy * float2( 1,1 ) + float2( 0,0 );
				float randomOffset532 = packedInput.uv1.x;
				...
				float3 objToWorld518 = GetAbsolutePositionWS(mul( GetObjectToWorldMatrix(), float4( float3( 0,0,0 ), 1 ) ).xyz);
				...
				float2 texCoord439 = packedInput.ase_texcoord6.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float2 texCoord436 = packedInput.ase_texcoord6.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float2 texCoord352 = packedInput.ase_texcoord6.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float2 texCoord356 = packedInput.ase_texcoord6.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float erodeIn534 = packedInput.ase_texcoord6.z;
				float temp_output_539_0 = ( erodeIn534 + _ErodeIn );
				float2 texCoord377 = packedInput.ase_texcoord6.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float erodeOut535 = packedInput.ase_texcoord6.w;
				float temp_output_537_0 = ( erodeOut535 + _ErodeOut );
				float2 texCoord385 = packedInput.ase_texcoord6.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float lerpResult3_g91 = lerp( ( -1.0 * temp_output_4_0_g91 ) , temp_output_4_0_g91 , isFrontFace);
				...
				float4 fetchOpaqueVal23 = ASEHDSampleSceneColor(( (ase_screenPosNorm).xy + ( ( ( (WaterNormal140).xy + -0.5 ) * 2.0 ) * lerpResult205 ) ), 0.0, GetInverseCurrentExposureMultiplier());
				float4 temp_output_39_0 = ( ( float4( _Color01 , 0.0 ) * packedInput.ase_color ) * ( fetchOpaqueVal23 * 0.0001 ) );
				...
				float lerpResult3_g89 = lerp( ( -1.0 * temp_output_4_0_g89 ) , temp_output_4_0_g89 , isFrontFace);
				...
				float customEye170 = packedInput.ase_texcoord7.w;
				...
				surfaceDescription.BaseColor = temp_output_39_0.rgb;
				surfaceDescription.Normal = WaterNormal140;
				...
				surfaceDescription.Emission = ( temp_output_39_0 * _Emission ).rgb;
				surfaceDescription.Smoothness = smoothness90;
				surfaceDescription.Occlusion = 1;
				surfaceDescription.Alpha = saturate( ( packedInput.ase_color.a * saturate( ( saturate( ( saturate( ( DF59 * DSFres181 ) ) * camDF183 ) ) * gangnamStyle397 ) ) ) );
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				float3 customSurfaceDepth170 = inputMesh.positionOS;
				float customEye170 = -TransformWorldToView(TransformObjectToWorld(customSurfaceDepth170)).z;
				outputPackedVaryingsMeshToPS.ase_texcoord5.w = customEye170;
				
				outputPackedVaryingsMeshToPS.ase_color = inputMesh.ase_color;
				outputPackedVaryingsMeshToPS.ase_texcoord3 = inputMesh.uv0;
				outputPackedVaryingsMeshToPS.ase_texcoord4 = inputMesh.uv1;
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float4 ase_screenPosNorm = screenPos / screenPos.w;
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float2 texCoord437 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult433 = (float2(0.005 , 0.0));
				float wavesTiling444 = _WavesTiling;
				float2 temp_cast_1 = (( wavesTiling444 / 2.0 )).xx;
				float2 temp_output_2_0_g93 = ( ( ( texCoord437 + appendResult433 ) * wavesTiling444 ) - temp_cast_1 );
				...
				float2 temp_output_468_0 = appendResult20_g93;
				float saferPower469 = abs( (temp_output_468_0).y );
				float2 texCoord423 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float randomOffset532 = packedInput.ase_texcoord4.x;
				float4 tex2DNode419 = tex2D( _UVNoise, ( ( texCoord423 * _UVNoiseScale ) + randomOffset532 ) );
				float2 appendResult429 = (float2(( ( tex2DNode419.r + -0.2 ) * 2.0 ) , ( ( tex2DNode419.g + -0.2 ) * 2.0 )));
				float2 UVNoise421 = ( appendResult429 * _UVNoiseIntensity );
				float2 appendResult472 = (float2((temp_output_468_0).x , ( pow( saferPower469 , 2.0 ) + UVNoise421 ).x));
				...
				float3 appendResult410 = (float3(1.0 , 0.0 , ( ( tex2D( _WaveMask, ( ( appendResult472 - appendResult475 ) + worldUVNoise364 ) ).g - tex2DNode403.g ) * _WavesIntensity )));
				float2 appendResult434 = (float2(0.0 , 0.005));
				float2 texCoord436 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 temp_cast_7 = (( wavesTiling444 / 2.0 )).xx;
				float2 temp_output_2_0_g95 = ( ( ( appendResult434 + texCoord436 ) * wavesTiling444 ) - temp_cast_7 );
				float2 temp_output_15_0_g95 = ( temp_output_2_0_g95 * temp_output_2_0_g95 );
				float2 appendResult20_g95 = (float2(frac( ( atan2( (temp_output_2_0_g95).x , (temp_output_2_0_g95).y ) / 6.283 ) ) , sqrt( ( (temp_output_15_0_g95).x + (temp_output_15_0_g95).y ) )));
				...
				float2 appendResult508 = (float2(0.0 , frac( ( _TimeParameters.x * wavesSpeed482 ) )));
				float3 appendResult411 = (float3(0.0 , 1.0 , ( ( tex2DNode403.g - tex2D( _WaveMask, ( ( appendResult504 - appendResult508 ) + worldUVNoise364 ) ).g ) * _WavesIntensity )));
				float2 texCoord352 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float clampResult9_g86 = clamp( ( ( length( (float2( -1,-1 ) + (( texCoord352 + worldUVNoise364 ) - float2( 0,0 )) * (float2( 1,1 ) - float2( -1,-1 )) / (float2( 1,1 ) - float2( 0,0 ))) ) + -0.666 ) * 4.2 ) , 0.0 , 1.0 );
				float2 texCoord356 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float clampResult9_g87 = clamp( ( ( length( (float2( -1,-1 ) + (texCoord356 - float2( 0,0 )) * (float2( 1,1 ) - float2( -1,-1 )) / (float2( 1,1 ) - float2( 0,0 ))) ) + -0.5 ) * 2.0 ) , 0.0 , 1.0 );
				float erodeIn534 = packedInput.ase_texcoord3.z;
				float temp_output_539_0 = ( erodeIn534 + _ErodeIn );
				float2 texCoord377 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float clampResult9_g88 = clamp( ( ( length( (float2( -1,-1 ) + (texCoord377 - float2( 0,0 )) * (float2( 1,1 ) - float2( -1,-1 )) / (float2( 1,1 ) - float2( 0,0 ))) ) + -0.2 ) * 1.0 ) , 0.0 , 1.0 );
				float smoothstepResult372 = smoothstep( temp_output_539_0 , ( temp_output_539_0 + 0.5 ) , ( 1.0 - saturate( clampResult9_g88 ) ));
				float erodeOut535 = packedInput.ase_texcoord3.w;
				float temp_output_537_0 = ( erodeOut535 + _ErodeOut );
				float2 texCoord385 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float clampResult9_g90 = clamp( ( ( length( (float2( -1,-1 ) + (texCoord385 - float2( 0,0 )) * (float2( 1,1 ) - float2( -1,-1 )) / (float2( 1,1 ) - float2( 0,0 ))) ) + -0.2 ) * 1.0 ) , 0.0 , 1.0 );
				float smoothstepResult375 = smoothstep( temp_output_537_0 , ( temp_output_537_0 + 0.5 ) , saturate( clampResult9_g90 ));
				float temp_output_392_0 = saturate( ( saturate( ( saturate( ( ( 1.0 - saturate( clampResult9_g86 ) ) * ( 1.0 - saturate( clampResult9_g87 ) ) ) ) * smoothstepResult372 ) ) * smoothstepResult375 ) );
				float3 lerpResult347 = lerp( float3(0,0,1) , cross( appendResult410 , appendResult411 ) , temp_output_392_0);
				...
				float temp_output_178_0 = fresnelNode1_g89;
				float DSFres181 = saturate( temp_output_178_0 );
				float customEye170 = packedInput.ase_texcoord5.w;
				float cameraDepthFade170 = (( customEye170 -_ProjectionParams.y - _CameraDepthFadeOffset ) / _CameraDepthFadeLength);
				float camDF183 = saturate( cameraDepthFade170 );
				float gangnamStyle397 = temp_output_392_0;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float3 customSurfaceDepth170 = inputMesh.positionOS;
				float customEye170 = -TransformWorldToView(TransformObjectToWorld(customSurfaceDepth170)).z;
				outputPackedVaryingsMeshToPS.ase_texcoord2.w = customEye170;
			...
			UNITY_SETUP_INSTANCE_ID(packedInput);
				...
				float temp_output_178_0 = fresnelNode1_g89;
				float DSFres181 = saturate( temp_output_178_0 );
				float customEye170 = packedInput.ase_texcoord2.w;
				float cameraDepthFade170 = (( customEye170 -_ProjectionParams.y - _CameraDepthFadeOffset ) / _CameraDepthFadeLength);
				float camDF183 = saturate( cameraDepthFade170 );
				float2 texCoord352 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				float3 objToWorld518 = GetAbsolutePositionWS(mul( GetObjectToWorldMatrix(), float4( float3( 0,0,0 ), 1 ) ).xyz);
				#ifdef _USEWORLDSPACE_ON
				float3 staticSwitch525 = ase_worldPos;
				#else
				...
				float2 worldUVNoise364 = ( appendResult527 * _WorldUVNoiseIntensity );
				float clampResult9_g86 = clamp( ( ( length( (float2( -1,-1 ) + (( texCoord352 + worldUVNoise364 ) - float2( 0,0 )) * (float2( 1,1 ) - float2( -1,-1 )) / (float2( 1,1 ) - float2( 0,0 ))) ) + -0.666 ) * 4.2 ) , 0.0 , 1.0 );
				float2 texCoord356 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				float clampResult9_g87 = clamp( ( ( length( (float2( -1,-1 ) + (texCoord356 - float2( 0,0 )) * (float2( 1,1 ) - float2( -1,-1 )) / (float2( 1,1 ) - float2( 0,0 ))) ) + -0.5 ) * 2.0 ) , 0.0 , 1.0 );
				float erodeIn534 = packedInput.ase_texcoord5.z;
				float temp_output_539_0 = ( erodeIn534 + _ErodeIn );
				float2 texCoord377 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				float clampResult9_g88 = clamp( ( ( length( (float2( -1,-1 ) + (texCoord377 - float2( 0,0 )) * (float2( 1,1 ) - float2( -1,-1 )) / (float2( 1,1 ) - float2( 0,0 ))) ) + -0.2 ) * 1.0 ) , 0.0 , 1.0 );
				float smoothstepResult372 = smoothstep( temp_output_539_0 , ( temp_output_539_0 + 0.5 ) , ( 1.0 - saturate( clampResult9_g88 ) ));
				float erodeOut535 = packedInput.ase_texcoord5.w;
				float temp_output_537_0 = ( erodeOut535 + _ErodeOut );
				float2 texCoord385 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				float clampResult9_g90 = clamp( ( ( length( (float2( -1,-1 ) + (texCoord385 - float2( 0,0 )) * (float2( 1,1 ) - float2( -1,-1 )) / (float2( 1,1 ) - float2( 0,0 ))) ) + -0.2 ) * 1.0 ) , 0.0 , 1.0 );
				float smoothstepResult375 = smoothstep( temp_output_537_0 , ( temp_output_537_0 + 0.5 ) , saturate( clampResult9_g90 ));
				float temp_output_392_0 = saturate( ( saturate( ( saturate( ( ( 1.0 - saturate( clampResult9_g86 ) ) * ( 1.0 - saturate( clampResult9_g87 ) ) ) ) * smoothstepResult372 ) ) * smoothstepResult375 ) );
				float gangnamStyle397 = temp_output_392_0;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float3 customSurfaceDepth170 = inputMesh.positionOS;
				float customEye170 = -TransformWorldToView(TransformObjectToWorld(customSurfaceDepth170)).z;
				outputPackedVaryingsMeshToPS.ase_texcoord6.w = customEye170;
			...
			UNITY_SETUP_INSTANCE_ID(packedInput);
				...
				float temp_output_178_0 = fresnelNode1_g89;
				float DSFres181 = saturate( temp_output_178_0 );
				float customEye170 = packedInput.ase_texcoord6.w;
				float cameraDepthFade170 = (( customEye170 -_ProjectionParams.y - _CameraDepthFadeOffset ) / _CameraDepthFadeLength);
				float camDF183 = saturate( cameraDepthFade170 );
				float gangnamStyle397 = temp_output_392_0;
		...
		Pass
		{
			...
			AttributesMesh ApplyMeshModification(AttributesMesh inputMesh, float3 timeParameters, inout PackedVaryingsMeshToPS outputPackedVaryingsMeshToPS )
			{
				...
				float3 customSurfaceDepth170 = inputMesh.positionOS;
				float customEye170 = -TransformWorldToView(TransformObjectToWorld(customSurfaceDepth170)).z;
				outputPackedVaryingsMeshToPS.ase_texcoord9.w = customEye170;
						...
						)
			{
				...
				float4 ase_screenPosNorm = screenPos / screenPos.w;
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float2 texCoord437 = packedInput.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult433 = (float2(0.005 , 0.0));
				float wavesTiling444 = _WavesTiling;
				float2 temp_cast_1 = (( wavesTiling444 / 2.0 )).xx;
				float2 temp_output_2_0_g93 = ( ( ( texCoord437 + appendResult433 ) * wavesTiling444 ) - temp_cast_1 );
				...
				float2 temp_output_468_0 = appendResult20_g93;
				float saferPower469 = abs( (temp_output_468_0).y );
				float2 texCoord423 = packedInput.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				float randomOffset532 = packedInput.uv1.x;
				float4 tex2DNode419 = tex2D( _UVNoise, ( ( texCoord423 * _UVNoiseScale ) + randomOffset532 ) );
				float2 appendResult429 = (float2(( ( tex2DNode419.r + -0.2 ) * 2.0 ) , ( ( tex2DNode419.g + -0.2 ) * 2.0 )));
				float2 UVNoise421 = ( appendResult429 * _UVNoiseIntensity );
				...
				float2 appendResult527 = (float2(( ( tex2DNode365.r + -0.2 ) * 2.0 ) , ( ( tex2DNode365.g + -0.2 ) * 2.0 )));
				float2 worldUVNoise364 = ( appendResult527 * _WorldUVNoiseIntensity );
				float2 texCoord439 = packedInput.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				float2 temp_cast_5 = (( wavesTiling444 / 2.0 )).xx;
				float2 temp_output_2_0_g94 = ( ( texCoord439 * wavesTiling444 ) - temp_cast_5 );
				float2 temp_output_15_0_g94 = ( temp_output_2_0_g94 * temp_output_2_0_g94 );
				float2 appendResult20_g94 = (float2(frac( ( atan2( (temp_output_2_0_g94).x , (temp_output_2_0_g94).y ) / 6.283 ) ) , sqrt( ( (temp_output_15_0_g94).x + (temp_output_15_0_g94).y ) )));
				...
				float3 appendResult410 = (float3(1.0 , 0.0 , ( ( tex2D( _WaveMask, ( ( appendResult472 - appendResult475 ) + worldUVNoise364 ) ).g - tex2DNode403.g ) * _WavesIntensity )));
				float2 appendResult434 = (float2(0.0 , 0.005));
				float2 texCoord436 = packedInput.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				float2 temp_cast_7 = (( wavesTiling444 / 2.0 )).xx;
				float2 temp_output_2_0_g95 = ( ( ( appendResult434 + texCoord436 ) * wavesTiling444 ) - temp_cast_7 );
				float2 temp_output_15_0_g95 = ( temp_output_2_0_g95 * temp_output_2_0_g95 );
				float2 appendResult20_g95 = (float2(frac( ( atan2( (temp_output_2_0_g95).x , (temp_output_2_0_g95).y ) / 6.283 ) ) , sqrt( ( (temp_output_15_0_g95).x + (temp_output_15_0_g95).y ) )));
				...
				float2 appendResult508 = (float2(0.0 , frac( ( _TimeParameters.x * wavesSpeed482 ) )));
				float3 appendResult411 = (float3(0.0 , 1.0 , ( ( tex2DNode403.g - tex2D( _WaveMask, ( ( appendResult504 - appendResult508 ) + worldUVNoise364 ) ).g ) * _WavesIntensity )));
				float2 texCoord352 = packedInput.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				float clampResult9_g86 = clamp( ( ( length( (float2( -1,-1 ) + (( texCoord352 + worldUVNoise364 ) - float2( 0,0 )) * (float2( 1,1 ) - float2( -1,-1 )) / (float2( 1,1 ) - float2( 0,0 ))) ) + -0.666 ) * 4.2 ) , 0.0 , 1.0 );
				float2 texCoord356 = packedInput.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				float clampResult9_g87 = clamp( ( ( length( (float2( -1,-1 ) + (texCoord356 - float2( 0,0 )) * (float2( 1,1 ) - float2( -1,-1 )) / (float2( 1,1 ) - float2( 0,0 ))) ) + -0.5 ) * 2.0 ) , 0.0 , 1.0 );
				float erodeIn534 = packedInput.ase_texcoord8.z;
				float temp_output_539_0 = ( erodeIn534 + _ErodeIn );
				float2 texCoord377 = packedInput.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				float clampResult9_g88 = clamp( ( ( length( (float2( -1,-1 ) + (texCoord377 - float2( 0,0 )) * (float2( 1,1 ) - float2( -1,-1 )) / (float2( 1,1 ) - float2( 0,0 ))) ) + -0.2 ) * 1.0 ) , 0.0 , 1.0 );
				float smoothstepResult372 = smoothstep( temp_output_539_0 , ( temp_output_539_0 + 0.5 ) , ( 1.0 - saturate( clampResult9_g88 ) ));
				float erodeOut535 = packedInput.ase_texcoord8.w;
				float temp_output_537_0 = ( erodeOut535 + _ErodeOut );
				float2 texCoord385 = packedInput.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				float clampResult9_g90 = clamp( ( ( length( (float2( -1,-1 ) + (texCoord385 - float2( 0,0 )) * (float2( 1,1 ) - float2( -1,-1 )) / (float2( 1,1 ) - float2( 0,0 ))) ) + -0.2 ) * 1.0 ) , 0.0 , 1.0 );
				float smoothstepResult375 = smoothstep( temp_output_537_0 , ( temp_output_537_0 + 0.5 ) , saturate( clampResult9_g90 ));
				float temp_output_392_0 = saturate( ( saturate( ( saturate( ( ( 1.0 - saturate( clampResult9_g86 ) ) * ( 1.0 - saturate( clampResult9_g87 ) ) ) ) * smoothstepResult372 ) ) * smoothstepResult375 ) );
				float3 lerpResult347 = lerp( float3(0,0,1) , cross( appendResult410 , appendResult411 ) , temp_output_392_0);
				...
				float temp_output_178_0 = fresnelNode1_g89;
				float DSFres181 = saturate( temp_output_178_0 );
				float customEye170 = packedInput.ase_texcoord9.w;
				float cameraDepthFade170 = (( customEye170 -_ProjectionParams.y - _CameraDepthFadeOffset ) / _CameraDepthFadeLength);
				float camDF183 = saturate( cameraDepthFade170 );
				float gangnamStyle397 = temp_output_392_0;
		...
		Pass
        {
			...
			AttributesMesh ApplyMeshModification(AttributesMesh inputMesh, float3 timeParameters, inout PackedVaryingsMeshToPS outputPackedVaryingsMeshToPS )
			{
				...
				float3 customSurfaceDepth170 = inputMesh.positionOS;
				float customEye170 = -TransformWorldToView(TransformObjectToWorld(customSurfaceDepth170)).z;
				outputPackedVaryingsMeshToPS.ase_texcoord8.w = customEye170;
			...
			UNITY_SETUP_INSTANCE_ID(packedInput);
				...
				float temp_output_178_0 = fresnelNode1_g89;
				float DSFres181 = saturate( temp_output_178_0 );
				float customEye170 = packedInput.ase_texcoord8.w;
				float cameraDepthFade170 = (( customEye170 -_ProjectionParams.y - _CameraDepthFadeOffset ) / _CameraDepthFadeLength);
				float camDF183 = saturate( cameraDepthFade170 );
				float2 texCoord352 = packedInput.ase_texcoord9.xy * float2( 1,1 ) + float2( 0,0 );
				float3 objToWorld518 = GetAbsolutePositionWS(mul( GetObjectToWorldMatrix(), float4( float3( 0,0,0 ), 1 ) ).xyz);
				#ifdef _USEWORLDSPACE_ON
				float3 staticSwitch525 = ase_worldPos;
				#else
				...
				float2 worldUVNoise364 = ( appendResult527 * _WorldUVNoiseIntensity );
				float clampResult9_g86 = clamp( ( ( length( (float2( -1,-1 ) + (( texCoord352 + worldUVNoise364 ) - float2( 0,0 )) * (float2( 1,1 ) - float2( -1,-1 )) / (float2( 1,1 ) - float2( 0,0 ))) ) + -0.666 ) * 4.2 ) , 0.0 , 1.0 );
				float2 texCoord356 = packedInput.ase_texcoord9.xy * float2( 1,1 ) + float2( 0,0 );
				float clampResult9_g87 = clamp( ( ( length( (float2( -1,-1 ) + (texCoord356 - float2( 0,0 )) * (float2( 1,1 ) - float2( -1,-1 )) / (float2( 1,1 ) - float2( 0,0 ))) ) + -0.5 ) * 2.0 ) , 0.0 , 1.0 );
				float erodeIn534 = packedInput.ase_texcoord9.z;
				float temp_output_539_0 = ( erodeIn534 + _ErodeIn );
				float2 texCoord377 = packedInput.ase_texcoord9.xy * float2( 1,1 ) + float2( 0,0 );
				float clampResult9_g88 = clamp( ( ( length( (float2( -1,-1 ) + (texCoord377 - float2( 0,0 )) * (float2( 1,1 ) - float2( -1,-1 )) / (float2( 1,1 ) - float2( 0,0 ))) ) + -0.2 ) * 1.0 ) , 0.0 , 1.0 );
				float smoothstepResult372 = smoothstep( temp_output_539_0 , ( temp_output_539_0 + 0.5 ) , ( 1.0 - saturate( clampResult9_g88 ) ));
				float erodeOut535 = packedInput.ase_texcoord9.w;
				float temp_output_537_0 = ( erodeOut535 + _ErodeOut );
				float2 texCoord385 = packedInput.ase_texcoord9.xy * float2( 1,1 ) + float2( 0,0 );
				float clampResult9_g90 = clamp( ( ( length( (float2( -1,-1 ) + (texCoord385 - float2( 0,0 )) * (float2( 1,1 ) - float2( -1,-1 )) / (float2( 1,1 ) - float2( 0,0 ))) ) + -0.2 ) * 1.0 ) , 0.0 , 1.0 );
				float smoothstepResult375 = smoothstep( temp_output_537_0 , ( temp_output_537_0 + 0.5 ) , saturate( clampResult9_g90 ));
				float temp_output_392_0 = saturate( ( saturate( ( saturate( ( ( 1.0 - saturate( clampResult9_g86 ) ) * ( 1.0 - saturate( clampResult9_g87 ) ) ) ) * smoothstepResult372 ) ) * smoothstepResult375 ) );
				float gangnamStyle397 = temp_output_392_0;
...
WireConnection;542;0;23;0
WireConnection;542;1;543;0
WireConnection;544;0;39;0
WireConnection;544;1;79;0
WireConnection;544;5;85;0
WireConnection;544;6;331;0
WireConnection;544;7;91;0
WireConnection;544;9;186;0
ASEEND*/
//CHKSM=F67D37BA4186308BB393044F0F273300F2F6F590

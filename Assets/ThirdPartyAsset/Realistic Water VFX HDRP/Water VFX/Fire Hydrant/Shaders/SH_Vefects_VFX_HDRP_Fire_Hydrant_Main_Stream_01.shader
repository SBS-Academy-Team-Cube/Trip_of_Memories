...
Shader "Vefects/SH_Vefects_VFX_HDRP_Fire_Hydrant_Main_Stream_01"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float op62 = saturate( ( saturate( ( saturate( ( saturate( ( saturate( ( saturate( ( saturate( ( saturate( ( ( tex2D( _HydrantTexture, panner70 ).r - temp_output_58_0 ) - ( 1.0 - streamStrength125 ) ) ) * _ThickPartsOpacity ) ) + saturate( ( _MistOpacity * streamStrength125 ) ) ) ) * ( 1.0 - saturate( texCoord149.y ) ) ) ) * distanceDepth36 ) ) * ( 1.0 - fresnelNode1_g14 ) ) ) * saturate( cameraDepthFade111 ) ) ) * packedInput.ase_color.a ) );
				float4 fetchOpaqueVal23 = ASEHDSampleSceneColor(( (ase_screenPosNorm).xy + ( ( ( (norm100).xy + -0.5 ) * 2.0 ) * ( ( _NormalDistortionIntensity * streamStrength125 ) * op62 ) ) ), 0.0, GetInverseCurrentExposureMultiplier());
				float4 temp_output_254_0 = ( fetchOpaqueVal23 * 0.0001 );
				float4 lerpResult24 = lerp( temp_output_254_0 , ( float4( _Color01 , 0.0 ) + temp_output_254_0 ) , _ColorStrength);
...
WireConnection;239;1;254;0
WireConnection;254;0;23;0
WireConnection;254;1;255;0
WireConnection;243;0;24;0
WireConnection;243;1;101;0
WireConnection;243;5;104;0
WireConnection;243;6;102;0
WireConnection;243;7;105;0
WireConnection;243;9;63;0
WireConnection;243;11;201;0
ASEEND*/
//CHKSM=9374528FFFCC1ED493D24E49FA86A11D2940B4D0

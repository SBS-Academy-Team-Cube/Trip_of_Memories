...
Shader "Vefects/SH_Vefects_VFX_HDRP_Fire_Hydrant_Main_Stream_02"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float streamStrength125 = ( _StreamStrength * inputMesh.ase_texcoord.w );
				...
				float3 WPO200 = ( ( ( ( tex2Dlod( _WPOTexture, float4( panner197, 0, 0.0) ).g + -0.5 ) * 2.0 ) * ( inputMesh.normalOS * _WPOStrength ) ) * ( saturate( texCoord205.y ) + 0.25 ) );
						...
						)
			{
				...
				float4 fetchOpaqueVal23 = ASEHDSampleSceneColor(( (ase_screenPosNorm).xy + ( ( ( (temp_output_163_0).xy + -0.5 ) * 2.0 ) * ( ( _NormalIntensity * streamStrength125 ) * ( op62 * packedInput.ase_color.a ) ) ) ), 0.0, GetInverseCurrentExposureMultiplier());
				...
				float lerpResult3_g19 = lerp( ( -1.0 * temp_output_4_0_g19 ) , temp_output_4_0_g19 , isFrontFace);
				...
				float3 temp_cast_14 = (( _Specular * opNoMist190 )).xxx;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				float streamStrength125 = ( _StreamStrength * inputMesh.uv0.w );
				float lerpResult222 = lerp( 0.1 , 1.0 , streamStrength125);
				float2 appendResult218 = (float2(texCoord195.x , ( texCoord195.y * lerpResult222 )));
				float2 panner197 = ( 1.0 * _Time.y * _WPOPanSpeed + ( appendResult218 * _WPOUVScale ));
...
Node;AmplifyShaderEditor.RangedFloatNode;241;-1024,128;Inherit;False;Constant;_Float1;Float 1;34;0;Create;True;0;0;0;False;0;False;0.0001;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;240;-1024,0;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;229;0,0;Float;False;True;-1;2;Rendering.HighDefinition.LightingShaderGraphGUI;0;14;Vefects/SH_Vefects_VFX_HDRP_Fire_Hydrant_Main_Stream_02;53b46d85872c5b24c8f4f0a1c3fe4c87;True;GBuffer;0;0;GBuffer;34;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;5;True;7;d3d11;metal;vulkan;xboxone;xboxseries;playstation;switch;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;0;True;_CullMode;False;False;False;False;False;False;False;False;False;True;True;0;True;_StencilRefGBuffer;255;False;;255;True;_StencilWriteMaskGBuffer;7;False;;3;False;;0;False;;0;False;;7;False;;3;False;;0;False;;0;False;;False;False;True;0;True;_ZTestGBuffer;False;True;1;LightMode=GBuffer;False;False;0;;0;0;Standard;38;Surface Type;1;638800697668338453;  Rendering Pass;1;0;  Refraction Model;0;0;    Blending Mode;0;0;    Blend Preserves Specular;0;638800697680735251;  Back Then Front Rendering;0;0;  Transparent Depth Prepass;0;0;  Transparent Depth Postpass;0;0;  ZWrite;0;0;  Z Test;4;0;Double-Sided;1;638800697760058728;Alpha Clipping;0;0;  Use Shadow Threshold;0;0;Material Type,InvertActionOnDeselection;4;638800697695160343;  Energy Conserving Specular;0;638800697727298336;  Transmission,InvertActionOnDeselection;0;0;Receive Decals;0;638800697731701253;Receive SSR;1;0;Receive SSR Transparent;0;0;Motion Vectors;1;0;  Add Precomputed Velocity;0;0;Specular AA;0;0;Specular Occlusion Mode;1;0;Override Baked GI;0;0;Depth Offset;0;0;  Conserative;1;0;GPU Instancing;1;0;LOD CrossFade;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position;1;0;0;11;True;True;True;True;True;True;False;False;False;True;True;False;;False;0
...
WireConnection;24;0;240;0
WireConnection;24;1;26;0
WireConnection;24;2;28;0
WireConnection;225;0;63;0
WireConnection;225;1;29;4
WireConnection;240;0;23;0
WireConnection;240;1;241;0
WireConnection;229;0;24;0
WireConnection;229;1;193;0
WireConnection;229;5;172;0
WireConnection;229;6;102;0
WireConnection;229;7;105;0
WireConnection;229;9;225;0
WireConnection;229;11;201;0
ASEEND*/
//CHKSM=25E658375029EB713DC54416F35FE9487402D32E

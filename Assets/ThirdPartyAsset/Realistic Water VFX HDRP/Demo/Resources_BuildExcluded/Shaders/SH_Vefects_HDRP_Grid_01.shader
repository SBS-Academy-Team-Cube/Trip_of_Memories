...
Shader "/_Vefects_/SH_Vefects_HDRP_Grid_01"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				surfaceDescription.BaseColor = ( ( tex2DNode14.r * lerpResult57 ) * _ColorOverall.rgb );
				surfaceDescription.Normal = lerpResult44;
		...
		Pass
		{
			...
			UNITY_SETUP_INSTANCE_ID(packedInput);
				...
				float2 texCoord18 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult23 = (float2(_TileX , _TileY));
				float2 UV27 = ( ( texCoord18 * _TileOverall ) * appendResult23 );
				float2 Offset34 = ( ( saturate( tex2D( _Masks, UV27 ).g ) - 1 ) * float3( 0,0,0 ).xy * _ParallaxScale ) + UV27;
				float2 BOUV38 = Offset34;
...
WireConnection;69;5;51;0
WireConnection;69;7;48;0
ASEEND*/
//CHKSM=0DE083B77604E20719A3E7AE70E08EA31B44D7EC
...
Shader "Vefects/SH_Vefects_VFX_HDRP_Water_Dripping_Strong_Thin_01"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float2 texCoord1_g22 = inputMesh.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float2 texCoord120 = inputMesh.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
						...
						)
			{
				...
				float2 texCoord1_g21 = packedInput.ase_texcoord6.xy * float2( 1,1 ) + float2( 0,0 );
				float3 ase_objectScale = float3( length( GetObjectToWorldMatrix()[ 0 ].xyz ), length( GetObjectToWorldMatrix()[ 1 ].xyz ), length( GetObjectToWorldMatrix()[ 2 ].xyz ) );
				...
				float2 texCoord1_g20 = packedInput.ase_texcoord6.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float2 texCoord1_g19 = packedInput.ase_texcoord6.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float2 texCoord94 = packedInput.ase_texcoord6.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float4 fetchOpaqueVal185 = ASEHDSampleSceneColor(( (ase_screenPosNorm).xy + ( ( ( refract197 + -0.5 ) * 2.0 ) * _RefractIntensity ) ), 0.0, GetInverseCurrentExposureMultiplier());
				float4 screenColor186 = ( fetchOpaqueVal185 * 0.0001 );
				float4 lerpResult189 = lerp( screenColor186 , ( screenColor186 * float4( _Color01.rgb , 0.0 ) ) , _ColorLerp);
				
				float2 texCoord1_g24 = packedInput.ase_texcoord6.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float2 uv_DrippingMask = packedInput.ase_texcoord6.xy * _DrippingMask_ST.xy + _DrippingMask_ST.zw;
				float temp_output_72_0 = ( saturate( max( Droplets45 , ( ( tex2D( _DrippingMask, uv_DrippingMask ).r - temp_output_98_0 ) * 5.0 ) ) ) * packedInput.ase_color.r );
				...
				float2 texCoord131 = packedInput.ase_texcoord6.xy * float2( 1,1 ) + float2( 0,0 );
				float lerpResult139 = lerp( 0.0 , temp_output_194_0 , _StreamStrength);
				
				surfaceDescription.BaseColor = lerpResult189.rgb;
				surfaceDescription.Normal = lerpResult140;
				...
				surfaceDescription.Alpha = ( ( ( Droplets45 * saturate( ( 1.0 - texCoord131.y ) ) ) + ( temp_output_72_0 * lerpResult139 ) ) * packedInput.ase_color.r );
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				float2 texCoord1_g22 = inputMesh.uv0.xy * float2( 1,1 ) + float2( 0,0 );
				float3 ase_objectScale = float3( length( GetObjectToWorldMatrix()[ 0 ].xyz ), length( GetObjectToWorldMatrix()[ 1 ].xyz ), length( GetObjectToWorldMatrix()[ 2 ].xyz ) );
				float2 appendResult4_g22 = (float2(( 0.5 * ase_objectScale.x ) , ( 0.5 * ase_objectScale.z )));
				float2 appendResult5_g22 = (float2(frac( ( _TimeParameters.x * -0.27 ) ) , frac( ( _TimeParameters.x * 2.0 ) )));
				float WPO_noise114 = tex2Dlod( _Noise, float4( ( float3( ( ( texCoord1_g22 * appendResult4_g22 ) + appendResult5_g22 ) ,  0.0 ) + float3( 0,0,0 ) ).xy, 0, 0.0) ).g;
				float2 texCoord120 = inputMesh.uv0.xy * float2( 1,1 ) + float2( 0,0 );
				float3 appendResult123 = (float3(WPO_noise114 , 0.0 , ( ( WPO_noise114 * 0.5 ) * saturate( ( 1.0 - texCoord120.y ) ) )));
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float lerpResult166 = lerp( 1.0 , temp_output_194_0 , _StreamStrength);
				float lerpResult167 = lerp( 1.0 , 5.0 , lerpResult166);
				float2 texCoord1_g21 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float3 ase_objectScale = float3( length( GetObjectToWorldMatrix()[ 0 ].xyz ), length( GetObjectToWorldMatrix()[ 1 ].xyz ), length( GetObjectToWorldMatrix()[ 2 ].xyz ) );
				float2 appendResult4_g21 = (float2(( _NormalTiling * ase_objectScale.x ) , ( _NormalTiling * ase_objectScale.z )));
				float2 appendResult5_g21 = (float2(0.0 , frac( ( _TimeParameters.x * _FlowSpeed ) )));
				float2 texCoord1_g20 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult4_g20 = (float2(1.0 , 1.0));
				float2 appendResult5_g20 = (float2(0.0 , frac( ( _TimeParameters.x * _FlowSpeed ) )));
				float Droplets45 = ( tex2D( _DrippingMask, ( float3( ( ( texCoord1_g21 * appendResult4_g21 ) + appendResult5_g21 ) ,  0.0 ) + float3( 0,0,0 ) ).xy ).g * tex2D( _DrippingMask, ( float3( ( ( texCoord1_g20 * appendResult4_g20 ) + appendResult5_g20 ) ,  0.0 ) + float3( 0,0,0 ) ).xy ).b );
				float2 texCoord1_g19 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult4_g19 = (float2(( _NormalTiling * ase_objectScale.x ) , ( _NormalTiling * ase_objectScale.z )));
				float2 appendResult5_g19 = (float2(0.0 , frac( ( _TimeParameters.x * _SubtractNoisePanSpeed ) )));
				float2 texCoord94 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float temp_output_98_0 = saturate( ( ( tex2D( _Noise, ( float3( ( ( texCoord1_g19 * appendResult4_g19 ) + appendResult5_g19 ) ,  0.0 ) + float3( 0,0,0 ) ).xy ).g * saturate( ( 1.0 - texCoord94.y ) ) ) * 2.0 ) );
				float lerpResult168 = lerp( 1.0 , lerpResult167 , saturate( max( Droplets45 , temp_output_98_0 ) ));
				float refract197 = lerpResult168;
				float4 fetchOpaqueVal185 = ASEHDSampleSceneColor(( (ase_screenPosNorm).xy + ( ( ( refract197 + -0.5 ) * 2.0 ) * _RefractIntensity ) ), 0.0, GetInverseCurrentExposureMultiplier());
				...
				float2 texCoord1_g24 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult4_g24 = (float2(( _NormalTiling * ase_objectScale.x ) , ( _NormalTiling * ase_objectScale.z )));
				float temp_output_147_0 = ( _TimeParameters.x * _FlowSpeed );
				float2 appendResult5_g24 = (float2(frac( ( temp_output_147_0 * 0.12 ) ) , frac( temp_output_147_0 )));
				float2 uv_DrippingMask = packedInput.ase_texcoord3.xy * _DrippingMask_ST.xy + _DrippingMask_ST.zw;
				float temp_output_72_0 = ( saturate( max( Droplets45 , ( ( tex2D( _DrippingMask, uv_DrippingMask ).r - temp_output_98_0 ) * 5.0 ) ) ) * packedInput.ase_color.r );
				float3 lerpResult140 = lerp( float3(0,0,1) , tex2D( _NoiseNormal, ( float3( ( ( texCoord1_g24 * appendResult4_g24 ) + appendResult5_g24 ) ,  0.0 ) + float3( 0,0,0 ) ).xy ).rgb , ( temp_output_72_0 * _NormalIntensity ));
		...
		Pass
		{
			...
			UNITY_SETUP_INSTANCE_ID(packedInput);
				...
				float2 texCoord1_g21 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float3 ase_objectScale = float3( length( GetObjectToWorldMatrix()[ 0 ].xyz ), length( GetObjectToWorldMatrix()[ 1 ].xyz ), length( GetObjectToWorldMatrix()[ 2 ].xyz ) );
				float2 appendResult4_g21 = (float2(( _NormalTiling * ase_objectScale.x ) , ( _NormalTiling * ase_objectScale.z )));
				float2 appendResult5_g21 = (float2(0.0 , frac( ( _TimeParameters.x * _FlowSpeed ) )));
				float2 texCoord1_g20 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult4_g20 = (float2(1.0 , 1.0));
				float2 appendResult5_g20 = (float2(0.0 , frac( ( _TimeParameters.x * _FlowSpeed ) )));
				float Droplets45 = ( tex2D( _DrippingMask, ( float3( ( ( texCoord1_g21 * appendResult4_g21 ) + appendResult5_g21 ) ,  0.0 ) + float3( 0,0,0 ) ).xy ).g * tex2D( _DrippingMask, ( float3( ( ( texCoord1_g20 * appendResult4_g20 ) + appendResult5_g20 ) ,  0.0 ) + float3( 0,0,0 ) ).xy ).b );
				float2 texCoord131 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float2 uv_DrippingMask = packedInput.ase_texcoord1.xy * _DrippingMask_ST.xy + _DrippingMask_ST.zw;
				float2 texCoord1_g19 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult4_g19 = (float2(( _NormalTiling * ase_objectScale.x ) , ( _NormalTiling * ase_objectScale.z )));
				float2 appendResult5_g19 = (float2(0.0 , frac( ( _TimeParameters.x * _SubtractNoisePanSpeed ) )));
				float2 texCoord94 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float temp_output_98_0 = saturate( ( ( tex2D( _Noise, ( float3( ( ( texCoord1_g19 * appendResult4_g19 ) + appendResult5_g19 ) ,  0.0 ) + float3( 0,0,0 ) ).xy ).g * saturate( ( 1.0 - texCoord94.y ) ) ) * 2.0 ) );
				float temp_output_72_0 = ( saturate( max( Droplets45 , ( ( tex2D( _DrippingMask, uv_DrippingMask ).r - temp_output_98_0 ) * 5.0 ) ) ) * packedInput.ase_color.r );
				float temp_output_194_0 = saturate( 1.0 );
				float lerpResult139 = lerp( 0.0 , temp_output_194_0 , _StreamStrength);
		...
		Pass
		{
						...
						)
			{
				...
				float lerpResult166 = lerp( 1.0 , temp_output_194_0 , _StreamStrength);
				float lerpResult167 = lerp( 1.0 , 5.0 , lerpResult166);
				float2 texCoord1_g21 = packedInput.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				float3 ase_objectScale = float3( length( GetObjectToWorldMatrix()[ 0 ].xyz ), length( GetObjectToWorldMatrix()[ 1 ].xyz ), length( GetObjectToWorldMatrix()[ 2 ].xyz ) );
				float2 appendResult4_g21 = (float2(( _NormalTiling * ase_objectScale.x ) , ( _NormalTiling * ase_objectScale.z )));
				float2 appendResult5_g21 = (float2(0.0 , frac( ( _TimeParameters.x * _FlowSpeed ) )));
				float2 texCoord1_g20 = packedInput.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult4_g20 = (float2(1.0 , 1.0));
				float2 appendResult5_g20 = (float2(0.0 , frac( ( _TimeParameters.x * _FlowSpeed ) )));
				float Droplets45 = ( tex2D( _DrippingMask, ( float3( ( ( texCoord1_g21 * appendResult4_g21 ) + appendResult5_g21 ) ,  0.0 ) + float3( 0,0,0 ) ).xy ).g * tex2D( _DrippingMask, ( float3( ( ( texCoord1_g20 * appendResult4_g20 ) + appendResult5_g20 ) ,  0.0 ) + float3( 0,0,0 ) ).xy ).b );
				float2 texCoord1_g19 = packedInput.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult4_g19 = (float2(( _NormalTiling * ase_objectScale.x ) , ( _NormalTiling * ase_objectScale.z )));
				float2 appendResult5_g19 = (float2(0.0 , frac( ( _TimeParameters.x * _SubtractNoisePanSpeed ) )));
				float2 texCoord94 = packedInput.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				float temp_output_98_0 = saturate( ( ( tex2D( _Noise, ( float3( ( ( texCoord1_g19 * appendResult4_g19 ) + appendResult5_g19 ) ,  0.0 ) + float3( 0,0,0 ) ).xy ).g * saturate( ( 1.0 - texCoord94.y ) ) ) * 2.0 ) );
				float lerpResult168 = lerp( 1.0 , lerpResult167 , saturate( max( Droplets45 , temp_output_98_0 ) ));
				float refract197 = lerpResult168;
				float4 fetchOpaqueVal185 = ASEHDSampleSceneColor(( (ase_screenPosNorm).xy + ( ( ( refract197 + -0.5 ) * 2.0 ) * _RefractIntensity ) ), 0.0, GetInverseCurrentExposureMultiplier());
				...
				float2 texCoord1_g24 = packedInput.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult4_g24 = (float2(( _NormalTiling * ase_objectScale.x ) , ( _NormalTiling * ase_objectScale.z )));
				float temp_output_147_0 = ( _TimeParameters.x * _FlowSpeed );
				float2 appendResult5_g24 = (float2(frac( ( temp_output_147_0 * 0.12 ) ) , frac( temp_output_147_0 )));
				float2 uv_DrippingMask = packedInput.ase_texcoord8.xy * _DrippingMask_ST.xy + _DrippingMask_ST.zw;
				float temp_output_72_0 = ( saturate( max( Droplets45 , ( ( tex2D( _DrippingMask, uv_DrippingMask ).r - temp_output_98_0 ) * 5.0 ) ) ) * packedInput.ase_color.r );
				float3 lerpResult140 = lerp( float3(0,0,1) , tex2D( _NoiseNormal, ( float3( ( ( texCoord1_g24 * appendResult4_g24 ) + appendResult5_g24 ) ,  0.0 ) + float3( 0,0,0 ) ).xy ).rgb , ( temp_output_72_0 * _NormalIntensity ));
				
				float3 temp_cast_10 = (_Specular).xxx;
				
				float2 texCoord131 = packedInput.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				float lerpResult139 = lerp( 0.0 , temp_output_194_0 , _StreamStrength);
		...
		Pass
        {
			...
			UNITY_SETUP_INSTANCE_ID(packedInput);
				...
				float2 texCoord1_g21 = packedInput.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float3 ase_objectScale = float3( length( GetObjectToWorldMatrix()[ 0 ].xyz ), length( GetObjectToWorldMatrix()[ 1 ].xyz ), length( GetObjectToWorldMatrix()[ 2 ].xyz ) );
				float2 appendResult4_g21 = (float2(( _NormalTiling * ase_objectScale.x ) , ( _NormalTiling * ase_objectScale.z )));
				float2 appendResult5_g21 = (float2(0.0 , frac( ( _TimeParameters.x * _FlowSpeed ) )));
				float2 texCoord1_g20 = packedInput.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult4_g20 = (float2(1.0 , 1.0));
				float2 appendResult5_g20 = (float2(0.0 , frac( ( _TimeParameters.x * _FlowSpeed ) )));
				float Droplets45 = ( tex2D( _DrippingMask, ( float3( ( ( texCoord1_g21 * appendResult4_g21 ) + appendResult5_g21 ) ,  0.0 ) + float3( 0,0,0 ) ).xy ).g * tex2D( _DrippingMask, ( float3( ( ( texCoord1_g20 * appendResult4_g20 ) + appendResult5_g20 ) ,  0.0 ) + float3( 0,0,0 ) ).xy ).b );
				float2 texCoord131 = packedInput.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float2 uv_DrippingMask = packedInput.ase_texcoord7.xy * _DrippingMask_ST.xy + _DrippingMask_ST.zw;
				float2 texCoord1_g19 = packedInput.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult4_g19 = (float2(( _NormalTiling * ase_objectScale.x ) , ( _NormalTiling * ase_objectScale.z )));
				float2 appendResult5_g19 = (float2(0.0 , frac( ( _TimeParameters.x * _SubtractNoisePanSpeed ) )));
				float2 texCoord94 = packedInput.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float temp_output_98_0 = saturate( ( ( tex2D( _Noise, ( float3( ( ( texCoord1_g19 * appendResult4_g19 ) + appendResult5_g19 ) ,  0.0 ) + float3( 0,0,0 ) ).xy ).g * saturate( ( 1.0 - texCoord94.y ) ) ) * 2.0 ) );
				float temp_output_72_0 = ( saturate( max( Droplets45 , ( ( tex2D( _DrippingMask, uv_DrippingMask ).r - temp_output_98_0 ) * 5.0 ) ) ) * packedInput.ase_color.r );
				float temp_output_194_0 = saturate( 1.0 );
				float lerpResult139 = lerp( 0.0 , temp_output_194_0 , _StreamStrength);
...
Node;AmplifyShaderEditor.CommentaryNode;206;-5298,2382;Inherit;False;1966;685.95;Screen Color;11;185;183;199;181;198;180;186;182;184;221;222;Screen Color;0,0,0,1;0;0
...
WireConnection;210;0;189;0
WireConnection;210;1;140;0
WireConnection;210;5;191;0
WireConnection;210;7;192;0
WireConnection;210;9;135;0
WireConnection;210;11;125;0
ASEEND*/
//CHKSM=0FDC3CBC332B4268A817F91CB153731C8CF2D3CB
...
Shader "Vefects/SH_Vefects_VFX_HDRP_Faucet_Water_Sink_01"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float4 temp_output_39_0 = ( ( float4( lerpResult49 , 0.0 ) * packedInput.ase_color ) * ( fetchOpaqueVal23 * 0.0001 ) );
				
				float spec84 = _Specular;
				float3 temp_cast_3 = (spec84).xxx;
...
WireConnection;357;0;23;0
WireConnection;357;1;358;0
WireConnection;346;0;39;0
WireConnection;346;1;79;0
WireConnection;346;5;85;0
WireConnection;346;6;331;0
WireConnection;346;7;91;0
WireConnection;346;9;186;0
ASEEND*/
//CHKSM=30210D52A49320A031978397E67FE57DB4CD44E2

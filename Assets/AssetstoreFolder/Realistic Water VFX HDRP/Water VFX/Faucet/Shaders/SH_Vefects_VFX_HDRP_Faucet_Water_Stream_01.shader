...
Shader "Vefects/SH_Vefects_VFX_HDRP_Faucet_Water_Stream_01"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float3 objToWorldDir303 = mul( GetObjectToWorldMatrix(), float4( inputMesh.normalOS, 0 ) ).xyz;
				float2 texCoord306 = inputMesh.ase_texcoord * float2( 1,1 ) + float2( 0,0 );
				float2 panner309 = ( 1.0 * _Time.y * _NormalUVPanSpeed + ( texCoord306 * _NormalUVScale ));
				float random305 = inputMesh.ase_texcoord.z;
						...
						)
			{
				...
				float2 texCoord306 = packedInput.ase_texcoord6.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner309 = ( 1.0 * _Time.y * _NormalUVPanSpeed + ( texCoord306 * _NormalUVScale ));
				float random305 = packedInput.ase_texcoord6.z;
				float4 tex2DNode94 = tex2D( _Normal, ( panner309 + random305 ) );
				float streamStrength288 = packedInput.ase_texcoord6.w;
				...
				float op62 = saturate( ( saturate( ( saturate( ( ( ( temp_output_299_0 * streamStrength288 ) * _OpacityMult ) * distanceDepth36 ) ) * saturate( cameraDepthFade111 ) ) ) * packedInput.ase_color.a ) );
				float4 fetchOpaqueVal286 = ASEHDSampleSceneColor(( (ase_screenPosNorm).xy + ( ( ( (norm100).xy + -0.5 ) * 2.0 ) * ( _NormalDistortionIntensity * op62 ) ) ), 0.0, GetInverseCurrentExposureMultiplier());
				float4 lerpResult24 = lerp( ( fetchOpaqueVal286 * 0.0001 ) , float4( _Color01 , 0.0 ) , _ColorStrength);
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				float3 objToWorldDir303 = mul( GetObjectToWorldMatrix(), float4( inputMesh.normalOS, 0 ) ).xyz;
				float2 texCoord306 = inputMesh.uv0.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner309 = ( 1.0 * _Time.y * _NormalUVPanSpeed + ( texCoord306 * _NormalUVScale ));
				float random305 = inputMesh.uv0.z;
				float4 tex2DNode94 = tex2Dlod( _Normal, float4( ( panner309 + random305 ), 0, 0.0) );
				float3 WPO314 = ( ( objToWorldDir303 * tex2DNode94.g ) * _WPOStrength );
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float4 ase_screenPosNorm = screenPos / screenPos.w;
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float2 texCoord306 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner309 = ( 1.0 * _Time.y * _NormalUVPanSpeed + ( texCoord306 * _NormalUVScale ));
				float random305 = packedInput.ase_texcoord3.z;
				float4 tex2DNode94 = tex2D( _Normal, ( panner309 + random305 ) );
				float streamStrength288 = packedInput.ase_texcoord3.w;
				float3 lerpResult235 = lerp( float3(0,0,1) , tex2DNode94.rgb , ( _NormalIntensity * streamStrength288 ));
				float3 norm100 = lerpResult235;
		...
		Pass
		{
			...
			UNITY_SETUP_INSTANCE_ID(packedInput);
				...
				float fresnelNode295 = ( _FresnelBias + _FresnelScale * pow( max( 1.0 - fresnelNdotV295 , 0.0001 ), _FresnelPower ) );
				float temp_output_299_0 = saturate( fresnelNode295 );
				float streamStrength288 = packedInput.ase_texcoord2.w;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				//setting value to unused interpolator channels and avoid initialization warnings
				outputPackedVaryingsMeshToPS.ase_texcoord5.yzw = 0;
		...
		Pass
		{
						...
						)
			{
				...
				float4 ase_screenPosNorm = screenPos / screenPos.w;
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float2 texCoord306 = packedInput.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner309 = ( 1.0 * _Time.y * _NormalUVPanSpeed + ( texCoord306 * _NormalUVScale ));
				float random305 = packedInput.ase_texcoord8.z;
				float4 tex2DNode94 = tex2D( _Normal, ( panner309 + random305 ) );
				float streamStrength288 = packedInput.ase_texcoord8.w;
				float3 lerpResult235 = lerp( float3(0,0,1) , tex2DNode94.rgb , ( _NormalIntensity * streamStrength288 ));
				float3 norm100 = lerpResult235;
				float3 ase_worldPos = GetAbsolutePositionWS( positionRWS );
				float3 ase_viewVectorWS = ( _WorldSpaceCameraPos.xyz - ase_worldPos );
		...
		Pass
        {
			...
			UNITY_SETUP_INSTANCE_ID(packedInput);
				...
				float3 ase_viewVectorWS = ( _WorldSpaceCameraPos.xyz - ase_worldPos );
				float3 ase_viewDirWS = normalize( ase_viewVectorWS );
				float fresnelNdotV295 = dot( packedInput.normalWS, ase_viewDirWS );
				float fresnelNode295 = ( _FresnelBias + _FresnelScale * pow( max( 1.0 - fresnelNdotV295 , 0.0001 ), _FresnelPower ) );
				float temp_output_299_0 = saturate( fresnelNode295 );
				float streamStrength288 = packedInput.ase_texcoord7.w;
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;333;-1024,0;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;334;-1024,128;Inherit;False;Constant;_Float0;Float 0;23;0;Create;True;0;0;0;False;0;False;0.0001;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;322;0,0;Float;False;True;-1;2;Rendering.HighDefinition.LightingShaderGraphGUI;0;14;Vefects/SH_Vefects_VFX_HDRP_Faucet_Water_Stream_01;53b46d85872c5b24c8f4f0a1c3fe4c87;True;GBuffer;0;0;GBuffer;34;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;5;True;7;d3d11;metal;vulkan;xboxone;xboxseries;playstation;switch;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;0;True;_CullMode;False;False;False;False;False;False;False;False;False;True;True;0;True;_StencilRefGBuffer;255;False;;255;True;_StencilWriteMaskGBuffer;7;False;;3;False;;0;False;;0;False;;7;False;;3;False;;0;False;;0;False;;False;False;True;0;True;_ZTestGBuffer;False;True;1;LightMode=GBuffer;False;False;0;;0;0;Standard;38;Surface Type;1;638800700628741064;  Rendering Pass;1;0;  Refraction Model;0;0;    Blending Mode;0;0;    Blend Preserves Specular;0;638800700641488430;  Back Then Front Rendering;0;0;  Transparent Depth Prepass;0;0;  Transparent Depth Postpass;0;0;  ZWrite;0;0;  Z Test;4;0;Double-Sided;1;638800700675749579;Alpha Clipping;0;0;  Use Shadow Threshold;0;0;Material Type,InvertActionOnDeselection;4;638800700595421830;  Energy Conserving Specular;0;638800700686317365;  Transmission,InvertActionOnDeselection;0;0;Receive Decals;0;638800700689840812;Receive SSR;1;0;Receive SSR Transparent;0;0;Motion Vectors;1;0;  Add Precomputed Velocity;0;0;Specular AA;0;0;Specular Occlusion Mode;1;0;Override Baked GI;0;0;Depth Offset;0;0;  Conserative;1;0;GPU Instancing;1;0;LOD CrossFade;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position;1;0;0;11;True;True;True;True;True;True;False;False;False;True;True;False;;False;0
...
WireConnection;333;0;286;0
WireConnection;333;1;334;0
WireConnection;322;0;24;0
WireConnection;322;1;101;0
WireConnection;322;5;104;0
WireConnection;322;6;102;0
WireConnection;322;7;105;0
WireConnection;322;9;63;0
WireConnection;322;11;316;0
ASEEND*/
//CHKSM=7CECB9DD4BDF1918FDD28DAE27EA493AD283E24A
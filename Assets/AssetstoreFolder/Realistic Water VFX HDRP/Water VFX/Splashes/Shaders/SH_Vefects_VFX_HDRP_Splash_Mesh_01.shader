...
Shader "Vefects/SH_Vefects_VFX_HDRP_Splash_Mesh_01"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float4 fetchOpaqueVal23 = ASEHDSampleSceneColor(( (ase_screenPosNorm).xy + ( packedInput.ase_color.r * _NormalIntensity ) ), 0.0, GetInverseCurrentExposureMultiplier());
				
				float smoothstepResult41 = smoothstep( packedInput.ase_texcoord6.z , ( packedInput.ase_texcoord6.z + _ErosionSmoothness ) , saturate( ( 1.0 - packedInput.ase_color.r ) ));
				...
				surfaceDescription.Emission = ( ( float4( _Color01.rgb , 0.0 ) * fetchOpaqueVal23 ) * _EmissionIntensity ).rgb;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float smoothstepResult41 = smoothstep( packedInput.ase_texcoord3.z , ( packedInput.ase_texcoord3.z + _ErosionSmoothness ) , saturate( ( 1.0 - packedInput.ase_color.r ) ));
				float screenDepth36 = LinearEyeDepth(SampleCameraDepth( ase_screenPosNorm.xy ),_ZBufferParams);
				float distanceDepth36 = saturate( ( screenDepth36 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _DepthFade ) );
		...
		Pass
		{
			...
			UNITY_SETUP_INSTANCE_ID(packedInput);
				...
				float smoothstepResult41 = smoothstep( packedInput.ase_texcoord1.z , ( packedInput.ase_texcoord1.z + _ErosionSmoothness ) , saturate( ( 1.0 - packedInput.ase_color.r ) ));
				float4 screenPos = packedInput.ase_texcoord2;
				float4 ase_screenPosNorm = screenPos / screenPos.w;
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float screenDepth36 = LinearEyeDepth(SampleCameraDepth( ase_screenPosNorm.xy ),_ZBufferParams);
		...
		Pass
		{
						...
						)
			{
				...
				float smoothstepResult41 = smoothstep( packedInput.ase_texcoord8.z , ( packedInput.ase_texcoord8.z + _ErosionSmoothness ) , saturate( ( 1.0 - packedInput.ase_color.r ) ));
				float screenDepth36 = LinearEyeDepth(SampleCameraDepth( ase_screenPosNorm.xy ),_ZBufferParams);
				float distanceDepth36 = saturate( ( screenDepth36 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _DepthFade ) );
		...
		Pass
        {
			...
			UNITY_SETUP_INSTANCE_ID(packedInput);
				...
				float smoothstepResult41 = smoothstep( packedInput.ase_texcoord7.z , ( packedInput.ase_texcoord7.z + _ErosionSmoothness ) , saturate( ( 1.0 - packedInput.ase_color.r ) ));
...
Node;AmplifyShaderEditor.RangedFloatNode;46;-2176,1024;Inherit;False;Property;_ErosionSmoothness;Erosion Smoothness;3;0;Create;True;0;0;0;False;0;False;1;0.1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;33;-1792,256;Inherit;False;Property;_NormalIntensity;Normal Intensity;1;0;Create;True;0;0;0;False;0;False;0.25;0.2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;10;640,0;Inherit;False;Property;_Cull;Cull;7;0;Create;True;0;0;0;True;3;Space(33);Header(AR);Space(13);False;0;2;0;0;0;1;FLOAT;0
...
WireConnection;68;5;59;0
WireConnection;68;6;57;0
WireConnection;68;7;60;0
WireConnection;68;9;62;0
ASEEND*/
//CHKSM=A2552392EB16C6A8DB4BF811CB96AAF13062EC20
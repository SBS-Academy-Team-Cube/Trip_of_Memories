...
Shader "Vefects/SH_Vefects_VFX_HDRP_Pressure_Washer_Stream_02"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float4 temp_output_253_0 = ( fetchOpaqueVal23 * 0.0001 );
				float4 lerpResult24 = lerp( temp_output_253_0 , ( float4( _Color01 , 0.0 ) + temp_output_253_0 ) , _ColorStrength);
...
WireConnection;242;1;101;0
WireConnection;242;5;104;0
WireConnection;242;6;102;0
WireConnection;242;7;105;0
WireConnection;242;9;63;0
ASEEND*/
//CHKSM=3844F5B5113EFCF168B330A1677929D9D4868C88
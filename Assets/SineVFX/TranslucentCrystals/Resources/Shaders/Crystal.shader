...
Shader "SineVFX/TranslucentCrystals/Crystal"
{
	Properties
	{
		...
		[DiffusionProfile]_DP("DP", Float) = 0[HideInInspector]_DP_Asset("DP", Vector) = ( 0, 0, 0, 0 )
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 uv_AlbedoMask = packedInput.ase_texcoord6.xy * _AlbedoMask_ST.xy + _AlbedoMask_ST.zw;
				...
				float2 uv_Emission = packedInput.ase_texcoord6.xy * _Emission_ST.xy + _Emission_ST.zw;
				float4 tex2DNode5 = tex2D( _Emission, uv_Emission );
				float2 uv_RampMask = packedInput.ase_texcoord6.xy * _RampMask_ST.xy + _RampMask_ST.zw;
				...
				#else
				float4 staticSwitch20 = ( tex2DNode5 * _EmissionColor2 * _EmissionPower );
				#endif
				
				float2 uv_MetallicSmoothness = packedInput.ase_texcoord6.xy * _MetallicSmoothness_ST.xy + _MetallicSmoothness_ST.zw;
				float4 tex2DNode12 = tex2D( _MetallicSmoothness, uv_MetallicSmoothness );
				
				float2 uv_TranslucencyMask = packedInput.ase_texcoord6.xy * _TranslucencyMask_ST.xy + _TranslucencyMask_ST.zw;
				...
				surfaceDescription.Emission = staticSwitch20.rgb;
				surfaceDescription.Smoothness = ( tex2DNode12.a * _Smoothness );
				...
				#if defined(_HAS_REFRACTION) || defined(_MATERIAL_FEATURE_TRANSMISSION)
				surfaceDescription.Thickness = ( tex2D( _TranslucencyMask, uv_TranslucencyMask ).r * _TranslucencyMaskPower );
				#endif
				...
				#if defined( _MATERIAL_FEATURE_SUBSURFACE_SCATTERING ) || defined( _MATERIAL_FEATURE_TRANSMISSION )
				surfaceDescription.DiffusionProfile = _DP;
				#endif
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_AlbedoMask = packedInput.ase_texcoord2.xy * _AlbedoMask_ST.xy + _AlbedoMask_ST.zw;
				float4 lerpResult17 = lerp( _ColorTint1 , _ColorTint2 , tex2D( _AlbedoMask, uv_AlbedoMask ).r);
				...
				float4 tex2DNode5 = tex2D( _Emission, uv_Emission );
				float2 uv_RampMask = packedInput.ase_texcoord2.xy * _RampMask_ST.xy + _RampMask_ST.zw;
				float4 tex2DNode22 = tex2D( _RampMask, uv_RampMask );
				#ifdef _RAMPINVERTED_ON
				float staticSwitch26 = ( 1.0 - tex2DNode22.r );
				#else
				...
				float2 uv_MetallicSmoothness = packedInput.ase_texcoord2.xy * _MetallicSmoothness_ST.xy + _MetallicSmoothness_ST.zw;
				float4 tex2DNode12 = tex2D( _MetallicSmoothness, uv_MetallicSmoothness );
				
				float2 uv_TranslucencyMask = packedInput.ase_texcoord2.xy * _TranslucencyMask_ST.xy + _TranslucencyMask_ST.zw;
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv_MetallicSmoothness = packedInput.ase_texcoord4.xy * _MetallicSmoothness_ST.xy + _MetallicSmoothness_ST.zw;
				float4 tex2DNode12 = tex2D( _MetallicSmoothness, uv_MetallicSmoothness );
		...
		Pass
		{
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_AlbedoMask = packedInput.ase_texcoord8.xy * _AlbedoMask_ST.xy + _AlbedoMask_ST.zw;
				float4 lerpResult17 = lerp( _ColorTint1 , _ColorTint2 , tex2D( _AlbedoMask, uv_AlbedoMask ).r);
				
				float2 uv_Normal = packedInput.ase_texcoord8.xy * _Normal_ST.xy + _Normal_ST.zw;
				
				float2 uv_Emission = packedInput.ase_texcoord8.xy * _Emission_ST.xy + _Emission_ST.zw;
				float4 tex2DNode5 = tex2D( _Emission, uv_Emission );
				float2 uv_RampMask = packedInput.ase_texcoord8.xy * _RampMask_ST.xy + _RampMask_ST.zw;
				float4 tex2DNode22 = tex2D( _RampMask, uv_RampMask );
				#ifdef _RAMPINVERTED_ON
				float staticSwitch26 = ( 1.0 - tex2DNode22.r );
				#else
				...
				float2 uv_MetallicSmoothness = packedInput.ase_texcoord8.xy * _MetallicSmoothness_ST.xy + _MetallicSmoothness_ST.zw;
				float4 tex2DNode12 = tex2D( _MetallicSmoothness, uv_MetallicSmoothness );
				
				float2 uv_TranslucencyMask = packedInput.ase_texcoord8.xy * _TranslucencyMask_ST.xy + _TranslucencyMask_ST.zw;
...
/*ASEBEGIN
Version=19801
Node;AmplifyShaderEditor.SamplerNode;22;-2179.814,-214.3205;Inherit;True;Property;_RampMask;Ramp Mask;13;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.OneMinusNode;27;-1799.809,-273.402;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.StaticSwitch;26;-1541.809,-220.402;Float;False;Property;_RampInverted;Ramp Inverted;11;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;24;-1426.426,-113.8341;Float;False;Constant;_Float0;Float 0;16;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;5;-979.7004,-52.65241;Inherit;True;Property;_Emission;Emission;6;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.ColorNode;39;-880.6624,131.2767;Inherit;False;Property;_EmissionColor2;Emission Color2;8;0;Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,1;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SamplerNode;21;-990.6935,-243.1058;Inherit;True;Property;_Ramp;Ramp;12;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.RangedFloatNode;8;-946.7004,304.3475;Float;False;Property;_EmissionPower;Emission Power;7;0;Create;True;0;0;0;False;0;False;2;0;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;11;-353.4277,428.8817;Float;False;Property;_TranslucencyMaskPower;Translucency Mask Power;1;0;Create;True;0;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;9;-370.1785,226.3078;Inherit;True;Property;_TranslucencyMask;Translucency Mask;0;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SamplerNode;1;-639.106,-941.1714;Inherit;True;Property;_AlbedoMask;Albedo Mask;2;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.RangedFloatNode;16;-506.0231,881.6746;Float;False;Property;_Smoothness;Smoothness;16;0;Create;True;0;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;18;-575.705,-1119.544;Float;False;Property;_ColorTint2;Color Tint 2;4;0;Create;True;0;0;0;False;0;False;1,1,1,1;0,0,0,0;False;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SamplerNode;12;-609.6003,599.6158;Inherit;True;Property;_MetallicSmoothness;MetallicSmoothness;14;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.ColorNode;3;-577.106,-1296.171;Float;False;Property;_ColorTint1;Color Tint 1;3;0;Create;True;0;0;0;False;0;False;1,1,1,1;0,0,0,0;False;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.SamplerNode;4;-637.4258,-737.2113;Inherit;True;Property;_Normal;Normal;5;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.StaticSwitch;20;-321.9658,-72.04562;Float;False;Property;_RampEnabled;Ramp Enabled;9;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.DiffusionProfileNode;40;198.3114,673.7811;Float;False;Property;_DP;DP;10;0;Create;True;0;0;0;False;0;False;0;0;False;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;10;10.57209,330.8818;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;14;-505.0231,797.6746;Float;False;Property;_Metallic;Metallic;15;0;Create;True;0;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
...
WireConnection;28;6;20;0
WireConnection;28;7;15;0
WireConnection;28;16;10;0
WireConnection;28;62;40;0
ASEEND*/
//CHKSM=0B11F7A003B2F9814F94700ADFD2D62AD2CD7B18